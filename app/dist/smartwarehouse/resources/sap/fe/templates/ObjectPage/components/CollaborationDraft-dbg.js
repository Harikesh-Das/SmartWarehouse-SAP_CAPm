 ...
 */
sap.ui.define(["sap/fe/base/BindingToolkit", "sap/fe/base/ClassSupport", "sap/fe/core/buildingBlocks/BuildingBlock", "sap/fe/core/controllerextensions/collaboration/CollaborationCommon", "sap/fe/core/formatters/CollaborationFormatter", "sap/fe/core/helpers/ModelHelper", "sap/fe/core/helpers/PromiseKeeper", "sap/fe/core/helpers/TypeGuards", "sap/fe/macros/CommonHelper", "sap/m/Avatar", "sap/m/Button", "sap/m/Dialog", "sap/m/HBox", "sap/m/Label", "sap/m/MessageStrip", "sap/m/MessageToast", "sap/m/ObjectStatus", "sap/m/ResponsivePopover", "sap/m/Text", "sap/m/VBox", "sap/ui/core/InvisibleText", "sap/ui/core/Lib", "sap/ui/core/library", "sap/ui/mdc/Field", "sap/ui/mdc/ValueHelp", "sap/ui/mdc/valuehelp/Dialog", "sap/ui/mdc/valuehelp/Popover", "sap/ui/mdc/valuehelp/content/MTable", "sap/fe/base/jsx-runtime/jsx", "sap/fe/base/jsx-runtime/jsxs", "sap/fe/base/jsx-runtime/Fragment"], function (BindingToolkit, ClassSupport, BuildingBlock, CollaborationCommon, collaborationFormatter, ModelHelper, PromiseKeeper, TypeGuards, CommonHelper, Avatar, Button, Dialog, HBox, Label, MessageStrip, MessageToast, ObjectStatus, ResponsivePopover, Text, VBox, InvisibleText, Lib, library, Field, ValueHelp, MDCDialog, MDCPopover, MTable, _jsx, _jsxs, _Fragment) {
  "use strict";
  ...
  let CollaborationDraft = (_dec = defineUI5Class("sap.fe.templates.ObjectPage.components.CollaborationDraft"), _dec2 = property({
    ...
    _proto.getManageDialogUserTableColumns = function getManageDialogUserTableColumns() {
      return _jsxs(_Fragment, {
        children: [_jsx(CollaborationDraft.GridTableColumnControl, {
          ...
          children: {
            label: _jsx(Text, {
              text: this.getTranslatedText("C_COLLABORATIONDRAFT_INVITATION_TABLE_USER_AVATAR_COLUMN")
            }),
            template: _jsx(HBox, {
              alignItems: "Center",
          ...
          children: {
            label: _jsx(Text, {
              text: this.getTranslatedText("C_COLLABORATIONDRAFT_INVITATION_TABLE_REMOVE_COLUMN")
            }),
            template: _jsx(HBox, {
    ...
    _proto.getManageDialogUserTable = function getManageDialogUserTable() {
      const tableTitle = _jsx(InvisibleText, {
        text: this.getTranslatedText("C_COLLABORATIONDRAFT_INVITATION_TABLE_TITLE")
      });
