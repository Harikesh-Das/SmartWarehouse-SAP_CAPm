  ...
  function getAdaptationPropertyValue(control, setting) {
    ...
    switch (setting.id) {
      case "avatarImageFitType":
        returnValue = viewDataSettings.content?.header?.avatar?.imageFitType !== undefined ? viewDataSettings.content.header.avatar.imageFitType : AvatarImageFitType.Cover;
        break;
