 ...
 */
sap.ui.define(["sap/m/AvatarImageFitType"], function (AvatarImageFitType) {
  "use strict";
  ...
  function getDesigntimeSettings() {
    ...
    const avatarImageFitType = {
      id: "avatarImageFitType",
      path: "content/header/avatar/imageFitType",
      name: "RTA_CONFIGURATION_OP_AIFT_NAME",
      description: "RTA_CONFIGURATION_OP_AIFT_DESC",
      type: "string",
      value: "Cover",
      enums: [{
        id: "Cover",
        name: "RTA_CONFIGURATION_OP_AIFT_ENUM_COVER"
      }, {
        id: "Contain",
        name: "RTA_CONFIGURATION_OP_AIFT_ENUM_CONTAIN"
      }]
    };
    ...
    return [avatarImageFitType, editableHeaderContent, variantManagement, sectionLayout, visible, showRelatedApps, openInEditMode, additionalSemanticObjects];
  }
  /**
  ...
  function getAdapationProperties(designtimeSettings, control) {
    const propertyValues = {
      avatarImageFitType: AvatarImageFitType.Cover,
    ...
    designtimeSettings.forEach(function (setting) {
      switch (setting.id) {
        case "avatarImageFitType":
          propertyValues.avatarImageFitType = viewDataSettings.content?.header?.avatar?.imageFitType !== undefined ? viewDataSettings.content.header.avatar.imageFitType : propertyValues.avatarImageFitType;
          break;
