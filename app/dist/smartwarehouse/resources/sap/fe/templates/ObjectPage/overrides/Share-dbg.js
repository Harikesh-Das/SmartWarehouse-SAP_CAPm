  ...
  const ShareExtensionOverride = {
    adaptShareMetadata: async function (oShareMetadata) {
      ...
      try {
        ...
        const oData = await Promise.all([getJamUrl(bIsEditable, bGlobalIsStickySupported, aActiveContextPaths), Promise.resolve(getShareUrl(bIsEditable, bGlobalIsStickySupported, aActiveContextPaths)), getShareEmailUrl()]);
