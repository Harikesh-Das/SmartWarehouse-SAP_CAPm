...
sap.ui.define(["sap/fe/base/ClassSupport", "sap/m/HBox", "sap/ui/core/StashedControlSupport"], function (ClassSupport, HBox, StashedControlSupport) {
  ...
  let StashableHBox = (_dec = defineUI5Class("sap.fe.templates.ObjectPage.controls.StashableHBox", {
    ...
    function StashableHBox() {
      ...
      _initializerDefineProperty(_this, "disableObjectPageRequestOptimization", _descriptor4, _this);
      _this.lastSetVisibleContext = undefined;
      return _this;
    }
    ...
    _proto.onBeforeRendering = function onBeforeRendering(oEvent) {
      ...
      return _HBox.prototype.onBeforeRendering.call(this, oEvent);
    };
     ...
     * @param lastContext
     */;
    _proto._refreshControlsBoundToNavigationProperties = function _refreshControlsBoundToNavigationProperties(lastContext) {
      ...
      this.findElements(true).forEach(elem => {
        ...
        if (this.getBindingContext() === lastContext) {
          const elemContext = elem.getBindingContext();
          ...
          if (elemContext && elemContext.getPath().startsWith(this.getBindingContext().getPath() + "/") && !contextToRefresh.includes(elemContext)) {
            contextToRefresh.push(elemContext);
          }
        }
      });
      contextToRefresh.forEach(async context => context.requestSideEffects([{
        $NavigationPropertyPath: ""
      }]));
    };
    _proto.setVisible = function setVisible(visible) {
      _HBox.prototype.setVisible.call(this, visible);
      if (!this.disableObjectPageRequestOptimization) {
        if (visible && (!this.getBinding("visible") || !this.getBinding("visible").getRawValue().includes(undefined))) {
      ...
      this.lastSetVisibleContext = this.getBindingContext();
      return this;
    };
    ...
    writable: true,
    initializer: null
  }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "disableObjectPageRequestOptimization", [_dec5], {
    configurable: true,
    enumerable: true,
    writable: true,
