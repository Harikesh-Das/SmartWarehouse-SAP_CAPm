...
sap.ui.define(["sap/fe/base/AnnotationEnum"], function (AnnotationEnum) {
   ...
   */
  const bindingToolkitNamespace = "sap.fe.base.BindingToolkit";

  /**
   * @typedef PathInModelExpression
   */
  _exports.bindingToolkitNamespace = bindingToolkitNamespace;
  function isProperty(serviceObject) {
    return serviceObject?._type === "Property";
  }
  _exports.isProperty = isProperty;
  function isActionParameter(serviceObject) {
    return serviceObject?._type === "ActionParameter";
  }
  ...
  function arithmetic(operator, leftOperand, rightOperand) {
    ...
    if (isConstant(leftExpression) && isConstant(rightExpression)) {
      switch (operator) {
        ...
        case "-":
          ...
          const diff = leftExpression.value - rightExpression.value;
        ...
        case "/":
          ...
          const div = leftExpression.value / rightExpression.value;
          return constant(div);
        case "Neg":
          if (leftExpression.value === null || leftExpression.value === undefined) {
            return constant(0);
        ...
        case "%":
          ...
          const mod = leftExpression.value % rightExpression.value;
          return constant(mod);
        case "Floor":
          if (leftExpression.value === null || leftExpression.value === undefined) {
            return constant(0);
          }
          return constant(Math.floor(leftExpression.value));
        case "*":
          if (leftExpression.value === null || leftExpression.value === undefined || rightExpression.value === null || rightExpression.value === undefined) {
            return constant(0);
          }
          const mult = leftExpression.value * rightExpression.value;
   ...
   */
  _exports.arithmetic = arithmetic;
  ...
  let CONVERTER_ROOT_SYMBOL;
  function setConverterRootSymbol(converterRootSymbol) {
   ...
   */
  _exports.setConverterRootSymbol = setConverterRootSymbol;
  function getExpressionFromAnnotation(annotationValue) {
    ...
    if (CONVERTER_ROOT_SYMBOL) {
      converterRoot = annotationValue?.[CONVERTER_ROOT_SYMBOL]?.();
    }
    ...
    switch (annotationValue.type) {
      ...
      case "If":
        return annotationIfExpression(annotationValue.$If, visitedNavigationPaths, pathVisitor, converterRoot);
      case "Not":
        return not(parseAnnotationCondition(annotationValue.$Not, visitedNavigationPaths, pathVisitor, converterRoot));
      case "Eq":
        return equal(parseAnnotationCondition(annotationValue.$Eq[0], visitedNavigationPaths, pathVisitor, converterRoot), parseAnnotationCondition(annotationValue.$Eq[1], visitedNavigationPaths, pathVisitor, converterRoot));
      case "Ne":
        return notEqual(parseAnnotationCondition(annotationValue.$Ne[0], visitedNavigationPaths, pathVisitor, converterRoot), parseAnnotationCondition(annotationValue.$Ne[1], visitedNavigationPaths, pathVisitor, converterRoot));
      case "Gt":
        return greaterThan(parseAnnotationCondition(annotationValue.$Gt[0], visitedNavigationPaths, pathVisitor, converterRoot), parseAnnotationCondition(annotationValue.$Gt[1], visitedNavigationPaths, pathVisitor, converterRoot));
      case "Ge":
        return greaterOrEqual(parseAnnotationCondition(annotationValue.$Ge[0], visitedNavigationPaths, pathVisitor, converterRoot), parseAnnotationCondition(annotationValue.$Ge[1], visitedNavigationPaths, pathVisitor, converterRoot));
      case "Lt":
        return lessThan(parseAnnotationCondition(annotationValue.$Lt[0], visitedNavigationPaths, pathVisitor, converterRoot), parseAnnotationCondition(annotationValue.$Lt[1], visitedNavigationPaths, pathVisitor, converterRoot));
      case "Le":
        return lessOrEqual(parseAnnotationCondition(annotationValue.$Le[0], visitedNavigationPaths, pathVisitor, converterRoot), parseAnnotationCondition(annotationValue.$Le[1], visitedNavigationPaths, pathVisitor, converterRoot));
      case "Or":
      ...
      case "In":
        return comparison("In", parseAnnotationCondition(annotationValue.$In[0], visitedNavigationPaths, pathVisitor, converterRoot), parseAnnotationCondition(annotationValue.$In[1], visitedNavigationPaths, pathVisitor, converterRoot));
      case "Has":
        return comparison("Has", parseAnnotationCondition(annotationValue.$Has[0], visitedNavigationPaths, pathVisitor, converterRoot), parseAnnotationCondition(annotationValue.$Has[1], visitedNavigationPaths, pathVisitor, converterRoot));
      case "Add":
        return add(parseAnnotationCondition(annotationValue.$Add[0], visitedNavigationPaths, pathVisitor, converterRoot), parseAnnotationCondition(annotationValue.$Add[1], visitedNavigationPaths, pathVisitor, converterRoot));
      case "Sub":
        return subtract(parseAnnotationCondition(annotationValue.$Sub[0], visitedNavigationPaths, pathVisitor, converterRoot), parseAnnotationCondition(annotationValue.$Sub[1], visitedNavigationPaths, pathVisitor, converterRoot));
      case "Mul":
        return multiply(parseAnnotationCondition(annotationValue.$Mul[0], visitedNavigationPaths, pathVisitor, converterRoot), parseAnnotationCondition(annotationValue.$Mul[1], visitedNavigationPaths, pathVisitor, converterRoot));
      case "Div":
        return floor(divide(parseAnnotationCondition(annotationValue.$Div[0], visitedNavigationPaths, pathVisitor, converterRoot), parseAnnotationCondition(annotationValue.$Div[1], visitedNavigationPaths, pathVisitor, converterRoot)));
      case "DivBy":
        return divide(parseAnnotationCondition(annotationValue.$DivBy[0], visitedNavigationPaths, pathVisitor, converterRoot), parseAnnotationCondition(annotationValue.$DivBy[1], visitedNavigationPaths, pathVisitor, converterRoot));
      case "Mod":
        return modulo(parseAnnotationCondition(annotationValue.$Mod[0], visitedNavigationPaths, pathVisitor, converterRoot), parseAnnotationCondition(annotationValue.$Mod[1], visitedNavigationPaths, pathVisitor, converterRoot));
      case "Neg":
        return negate(parseAnnotationCondition(annotationValue.$Neg[0], visitedNavigationPaths, pathVisitor, converterRoot));
      case "Apply":
  ...
  function parseAnnotationCondition(annotationValue) {
    ...
    let converterRoot = arguments.length > 3 ? arguments[3] : undefined;
    if (annotationValue === null || typeof annotationValue !== "object") {
      ...
      return constant(resolveEnumValue(annotationValue.$EnumMember, converterRoot));
      ...
      return negate(parseAnnotationCondition(annotationValue.$Neg, visitedNavigationPaths, pathVisitor, converterRoot));
    }
    return constant(annotationValue);
  }
  ...
  function annotationIfExpression(annotationValue) {
    ...
    let pathVisitor = arguments.length > 2 ? arguments[2] : undefined;
    let converterRoot = arguments.length > 3 ? arguments[3] : undefined;
    return ifElse(parseAnnotationCondition(annotationValue[0], visitedNavigationPaths, pathVisitor, converterRoot), parseAnnotationCondition(annotationValue[1], visitedNavigationPaths, pathVisitor, converterRoot), parseAnnotationCondition(annotationValue[2], visitedNavigationPaths, pathVisitor, converterRoot));
  }
        ...
        case "Has":
          {
            ...
            const leftValueInt = leftExpression.value;
            const rightValueInt = rightExpression.value;
        ...
        case "In":
          {
            ...
            const allChildrenConstants = rightExpression.value.every(item => isConstant(item));
            if (allChildrenConstants) {
              const rightValues = rightExpression.value.map(item => item.value);
  ...
  function includes(leftOperand, rightOperand) {
    return comparison("In", leftOperand, rightOperand);
  }
  ...
  function isExpressionStaticallyResolvable(exp) {
    const referencedPaths = [];
    transformRecursively(exp, "PathInModel", pathExp => {
  ...
  _exports.isExpressionStaticallyResolvable = isExpressionStaticallyResolvable;
  function getStaticallyResolvableExpression(exp, defaultValue) {
    if (exp._type === "Set") {
      const newOperands = exp.operands.map(operand => {
   ...
   */
  _exports.getStaticallyResolvableExpression = getStaticallyResolvableExpression;
  function concat() {
  ...
  function concatWithSeparator(separator) {
    for (var _len5 = arguments.length, inExpressions = new Array(_len5 > 1 ? _len5 - 1 : 0), _key5 = 1; _key5 < _len5; _key5++) {
      inExpressions[_key5 - 1] = arguments[_key5];
    }
    const expressions = inExpressions.map(wrapPrimitive);
    if (hasUnresolvableExpression(...expressions)) {
      return unresolvableExpression;
    ...
    if (expressions.every(isConstant)) {
      return constant(expressions.reduce((concatenated, value, index) => {
    ...
    const expressionsWithSeparators = [];
  ...
  _exports.concatWithSeparator = concatWithSeparator;
  function transformRecursively(inExpression, expressionType, transformFunction) {
    ...
    switch (expression._type) {
      ...
      case "Arithmetic":
        const operand1 = transformRecursively(expression.operand1, expressionType, transformFunction, includeAllExpression);
        const operand2 = transformRecursively(expression.operand2, expressionType, transformFunction, includeAllExpression);
        expression = arithmetic(expression.operator, operand1, operand2);
        break;
      case "Constant":
