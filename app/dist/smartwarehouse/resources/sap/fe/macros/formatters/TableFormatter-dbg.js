 ...
 */
sap.ui.define(["sap/base/Log", "sap/fe/core/CommonUtils", "sap/fe/core/formatters/Scope", "sap/fe/core/helpers/SizeHelper", "sap/fe/macros/DelegateUtil", "sap/fe/macros/table/TableSizeHelper", "sap/ui/core/message/MessageType", "sap/ui/mdc/enums/FieldEditMode"], function (Log, CommonUtils, Scope, SizeHelper, DelegateUtil, TableSizeHelper, MessageType, FieldEditMode) {
  "use strict";
  ...
  validateCreationRowFields.__functionName = "._formatters.TableFormatter#validateCreationRowFields";
  ...
  getErrorStatusTextVisibilityFormatter.__functionName = "._formatters.TableFormatter.bind($control)#getErrorStatusTextVisibilityFormatter";
  ...
  rowHighlighting.__functionName = "._formatters.TableFormatter.bind($control)#rowHighlighting";
  ...
  navigatedRow.__functionName = "._formatters.TableFormatter.bind($control)#navigatedRow";
  ...
  getColumnWidth.__functionName = "._formatters.TableFormatter.bind($control)#getColumnWidth";
  ...
  getColumnWidthForValueHelpTable.__functionName = "._formatters.TableFormatter.bind($control)#getColumnWidthForValueHelpTable";
  ...
  getVBoxVisibility.__functionName = "._formatters.TableFormatter.bind($control)#getVBoxVisibility";
  ...
  // @ts-ignore
  Scope._formatters.TableFormatter = tableFormatter;
