 ...
 */
sap.ui.define(["sap/base/Log", "sap/fe/base/ClassSupport", "sap/fe/macros/RichTextEditor", "sap/fe/macros/field/FieldTemplating", "./field/FieldRuntimeHelper"], function (Log, ClassSupport, RichTextEditorBlock, FieldTemplating, FieldRuntimeHelper) {
  "use strict";
  ...
  let RichTextEditorWithMetadata = (_dec = defineUI5Class("sap.fe.macros.RichTextEditorWithMetadata"), _dec2 = property({
    ...
    _proto.onMetadataAvailable = function onMetadataAvailable(_ownerComponent) {
      this.dataModelObjectPath = this.getDataModelObjectForMetaPath(this.metaPath, this.contextPath);
     ...
     * @param event
     */;
    _proto.handleValidateFieldGroup = function handleValidateFieldGroup(event) {
      const pageController = this.getPageController();
      const feController = pageController ? FieldRuntimeHelper.getExtensionController(pageController) : undefined;
