 ...
 */
sap.ui.define(["sap/base/Log", "sap/base/util/merge", "sap/fe/base/ClassSupport", "sap/fe/base/HookSupport", "sap/fe/core/CommonUtils", "sap/fe/core/converters/MetaModelConverter", "sap/fe/core/helpers/PromiseKeeper", "sap/fe/core/helpers/StableIdHelper", "sap/fe/core/library", "sap/fe/core/templating/DataModelPathHelper", "sap/fe/macros/MacroAPI", "sap/fe/macros/filter/FilterUtils", "sap/fe/macros/filterBar/SemanticDateOperators", "sap/fe/macros/mdc/adapter/StateHelper", "sap/fe/navigation/SelectionVariant", "sap/fe/navigation/library", "sap/ui/core/Element", "sap/ui/fl/apply/api/ControlVariantApplyAPI", "sap/ui/mdc/enums/FieldEditMode", "sap/ui/mdc/enums/FilterBarP13nMode", "sap/ui/mdc/p13n/StateUtil", "sap/ui/thirdparty/jquery", "./filterBar/FilterBarEventHandlersProvider", "./filterBar/FilterBarTemplate", "./filterBar/UOMValidationDelegate", "./filterBar/mixin/FilterBarAPIStateHandler"], function (Log, merge, ClassSupport, HookSupport, CommonUtils, MetaModelConverter, PromiseKeeper, StableIdHelper, library, DataModelPathHelper, MacroAPI, FilterUtils, SemanticDateOperators, stateHelper, SelectionVariant, navigationLibrary, UI5Element, ControlVariantApplyAPI, FieldEditMode, FilterBarP13nMode, StateUtil, jQuery, FilterBarEventHandlerProvider, FilterBarTemplate, UOMValidationDelegate, FilterBarAPIStateHandler) {
  "use strict";
  ...
  var setupFilterBarSettings = FilterBarTemplate.setupFilterBarSettings;
  var initializeInternalMetaContext = FilterBarTemplate.initializeInternalMetaContext;
  var getFEFilterBarTemplate = FilterBarTemplate.getFEFilterBarTemplate;
  var getExtraParams = FilterBarTemplate.getExtraParams;
  ...
  let FilterBarTelemetry = /*#__PURE__*/function () {
    function FilterBarTelemetry(filterBar) {
   ...
   * @public
   */
  let FilterBar = (_dec = defineUI5Class("sap.fe.macros.FilterBar", {
    ...
    altTypes: ["sap.fe.macros.filterBar.FilterFieldOverride"],
    multiple: true
  }), _dec11 = event(), _dec12 = event(), _dec13 = event(), _dec14 = event(), _dec15 = event(), _dec16 = property({
    type: "array"
  }), _dec17 = association({
    ...
    type: "string"
  }), _dec32 = controllerExtensionHandler("viewState", "retrieveAdditionalStates"), _dec33 = controllerExtensionHandler("viewState", "applyAdditionalStates"), _dec34 = xmlEventHandler(), _dec35 = xmlEventHandler(), _dec(_class = _dec2(_class = (_class2 = /*#__PURE__*/function (_MacroAPI) {
    function FilterBar(props, others) {
       ...
       * @public
       */
      _initializerDefineProperty(_this, "navigationPropertiesForPersonalization", _descriptor4, _this);
      /**
       ...
       * @public
       */
      _initializerDefineProperty(_this, "filterChanged", _descriptor10, _this);
      /**
       * This event is fired when the 'Clear' button is pressed. This is only possible when the 'Clear' button is enabled.
       * @public
       */
      _initializerDefineProperty(_this, "afterClear", _descriptor11, _this);
      /************************************************/
       ...
       * @private
       */
      _initializerDefineProperty(_this, "internalSearch", _descriptor12, _this);
      /**
       ...
       * @private
       */
      _initializerDefineProperty(_this, "selectionFields", _descriptor14, _this);
      /**
       * ID of the assigned variant management
       * NOTE: Used via LR Template
       * @private
       */
      _initializerDefineProperty(_this, "variantBackreference", _descriptor15, _this);
      /**
       * Don't show the basic search field
       * NOTE: Used via LR Template
       * @private
       */
      _initializerDefineProperty(_this, "hideBasicSearch", _descriptor16, _this);
      /**
       * Handles visibility of the 'Adapt Filters' button on the FilterBar
       * NOTE: Used via LR Template
       * @private
       */
      _initializerDefineProperty(_this, "showAdaptFiltersButton", _descriptor17, _this);
      /**
       * Specifies the Sematic Date Range option for the filter bar.
       * NOTE: Used via LR Template
       * @private
       */
      _initializerDefineProperty(_this, "useSemanticDateRange", _descriptor18, _this);
      /**
       ...
       * @private
       */
      _initializerDefineProperty(_this, "navigationProperties", _descriptor19, _this);
      /**
       * Filter conditions to be applied to the filter bar
       * NOTE: Used via LR Template
       * @private
       */
      _initializerDefineProperty(_this, "filterConditions", _descriptor20, _this);
      /**
       ...
       * @private
       */
      _initializerDefineProperty(_this, "suspendSelection", _descriptor21, _this);
      /**
       * This mode must be used when it is certain that a control must not persist it´s personalization state upon initialization.
       * @since 1.136.0
       * @private
       */
      _initializerDefineProperty(_this, "ignorePersonalizationChanges", _descriptor22, _this);
      /**
       ...
       * @private
       */
      _initializerDefineProperty(_this, "p13nMode", _descriptor24, _this);
      /**
       * Id of control that will allow for switching between normal and visual filter
       * @private
       */
      _initializerDefineProperty(_this, "toggleControlId", _descriptor25, _this);
      /**
       * Initial layout of the filter bar, either "compact" or "visual"
       * @private
       */
      _initializerDefineProperty(_this, "initialLayout", _descriptor26, _this);
      /**
       * Disable draft edit state filter.
       * @private
       */
      _initializerDefineProperty(_this, "disableDraftEditStateFilter", _descriptor27, _this);
      /**
       * Prefix to be used for the ids of the inner content controls.
       * @private
       */
      _initializerDefineProperty(_this, "idPrefix", _descriptor28, _this);
      /**
       * The identifier of the inner content FilterBar control.
       * @private
       */
      _initializerDefineProperty(_this, "_contentId", _descriptor29, _this);
      /***********************/
      /* INTERNAL PROPERTIES */
      /***********************/
      /**
       ...
       * @private
       */
      _this.isDraftCollaborative = false;
      /**
       ...
       * @private
       */
      _this._filterFieldDisplayPromises = [];
      /**
       * FilterFields promises from XML rendering(v2 BB)
       * @private
       */
      _this._filterFieldDisplayPropPromises = [];
      /**
       * FilterFields to be added to the FilterBar
       * @private
       */
      _this._filterFieldControls = [];
      /**
       * Show draft edit state in filter bar
       * @private
       */
      _this.showDraftEditState = false;
      _this.filterFieldConfigs = {};
     ...
     */
    _inheritsLoose(FilterBar, _MacroAPI);
    var _proto2 = FilterBar.prototype;
    /**
     ...
     */;
    _proto2.getFullMetaPath = function getFullMetaPath() {
     ...
     */;
    _proto2.setUpIds = function setUpIds() {
    ...
    _proto2.createContent = function createContent() {
      ...
      try {
        ...
        if (forceCreation || !this.content) {
          ...
          this.templateComponent = this._getOwner();
          ...
          this.content = this.templateComponent.runAsOwner(() => {
            ...
            const metaModel = this.templateComponent.getMetaModel() ?? this.templateComponent.preprocessorContext?.models.metaModel;
            ...
            const converterContext = MacroAPI.getConverterContext(visualizationObjectPath, this.contextPathToUse, templateProcessorSettings, extraParams);
        ...
        Log.error("Error creating filter bar content:", error);
      }
    }
     ...
     */;
    _proto2._setContentProperty = function _setContentProperty(propertyKey, propertyValue, bSuppressInvalidate) {
     ...
     */;
    _proto2.setProperty = function setProperty(propertyKey, propertyValue, bSuppressInvalidate) {
     ...
     */;
    _proto2.reCreateContent = function reCreateContent() {
      if (this.content) {
        this.createContent(true);
      }
    }
     ...
     * @since 1.147.0
     */;
    _proto2.addFilterField = function addFilterField(filterField) {
     ...
     * @since 1.147.0
     */;
    _proto2.removeFilterField = function removeFilterField(filterField) {
      const removedFilterField = this.removeAggregation("filterFields", filterField);
      this.reCreateContent();
     ...
     */;
    _proto2.setCustomFilterFieldProperties = function setCustomFilterFieldProperties() {
      this.filterFieldConfigs = (this.filterFields ?? []).reduce((overallFFConfigs, ff) => {
        const isCompleteFilterField = ff.isA("sap.fe.macros.filterBar.FilterField");
        ...
        const ffConfig = {
          ...
          slotName: ffKey,
          position: ff.anchor || ff.placement ? {
            anchor: ff.anchor ?? undefined,
            placement: ff.placement ?? undefined
          } : undefined,
    ...
    _proto2._applySelectionVariant = async function _applySelectionVariant(view, navigationParameter, filterVariantApplied) {
      ...
      if (shouldApplyAppState) {
        ...
        const useFLPDefaultValues = svDefaultsArePresent && (stdVariantIsDefaultVariant || !variantManagement) && Boolean(navigationParameter.navSelVarHasDefaultsOnly);
    ...
    _proto2.handleFilterChanged = async function handleFilterChanged(oEvent) {
    ...
    _proto2.getFilterFieldEnabled = function getFilterFieldEnabled(name) {
      return this.getInternalModel()?.getProperty(`/${this.content.data("localId")}/filterFields/${name}/editMode`) === FieldEditMode.Disabled ? false : true;
    }
    ...
    _proto2.setSelectionVariant = async function setSelectionVariant(selectionVariant) {
      ...
      let fromNavigationParameters = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
      const content = this.getContent();
      ...
      try {
        result = await stateHelper.setSelectionVariantToMdcControl(this.getContent(), selectionVariant, prefillDescriptions, fromNavigationParameters);
    ...
    writable: true,
    initializer: null
  }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "navigationPropertiesForPersonalization", [_dec6], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "liveMode", [_dec7], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
    ...
    writable: true,
    initializer: null
  }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "filterChanged", [_dec12], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, "afterClear", [_dec13], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, "internalSearch", [_dec14], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
    ...
    writable: true,
    initializer: null
  }), _descriptor14 = _applyDecoratedDescriptor(_class2.prototype, "selectionFields", [_dec16], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, "variantBackreference", [_dec17], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor16 = _applyDecoratedDescriptor(_class2.prototype, "hideBasicSearch", [_dec18], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor17 = _applyDecoratedDescriptor(_class2.prototype, "showAdaptFiltersButton", [_dec19], {
    configurable: true,
    enumerable: true,
    writable: true,
  ...
  }), _descriptor18 = _applyDecoratedDescriptor(_class2.prototype, "useSemanticDateRange", [_dec20], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
  ...
  }), _descriptor19 = _applyDecoratedDescriptor(_class2.prototype, "navigationProperties", [_dec21], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor20 = _applyDecoratedDescriptor(_class2.prototype, "filterConditions", [_dec22], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor21 = _applyDecoratedDescriptor(_class2.prototype, "suspendSelection", [_dec23], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
  ...
  }), _descriptor22 = _applyDecoratedDescriptor(_class2.prototype, "ignorePersonalizationChanges", [_dec24], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
  ...
  }), _descriptor23 = _applyDecoratedDescriptor(_class2.prototype, "_applyIdToContent", [_dec25], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
  ...
  }), _descriptor24 = _applyDecoratedDescriptor(_class2.prototype, "p13nMode", [_dec26], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor25 = _applyDecoratedDescriptor(_class2.prototype, "toggleControlId", [_dec27], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor26 = _applyDecoratedDescriptor(_class2.prototype, "initialLayout", [_dec28], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
  ...
  }), _descriptor27 = _applyDecoratedDescriptor(_class2.prototype, "disableDraftEditStateFilter", [_dec29], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor28 = _applyDecoratedDescriptor(_class2.prototype, "idPrefix", [_dec30], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor29 = _applyDecoratedDescriptor(_class2.prototype, "_contentId", [_dec31], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _applyDecoratedDescriptor(_class2.prototype, "retrieveAdditionalStates", [_dec32], Object.getOwnPropertyDescriptor(_class2.prototype, "retrieveAdditionalStates"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "applyAdditionalStates", [_dec33], Object.getOwnPropertyDescriptor(_class2.prototype, "applyAdditionalStates"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "handleSearch", [_dec34], Object.getOwnPropertyDescriptor(_class2.prototype, "handleSearch"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "handleFilterChanged", [_dec35], Object.getOwnPropertyDescriptor(_class2.prototype, "handleFilterChanged"), _class2.prototype), _class2)) || _class) || _class);
  return FilterBar;
}, false);
