 ...
 */
sap.ui.define(["sap/base/util/JSTokenizer", "sap/fe/base/BindingToolkit", "sap/fe/core/CommonUtils", "sap/fe/core/converters/controls/Common/filter/FilterRestrictions", "sap/fe/core/converters/controls/Common/table/Columns", "sap/fe/core/converters/MetaModelConverter", "sap/fe/core/templating/DataModelPathHelper", "sap/fe/core/templating/PropertyFormatters", "sap/fe/core/type/FiscalDate", "sap/fe/macros/CommonHelper", "sap/ui/base/BindingInfo", "sap/ui/model/odata/v4/AnnotationHelper"], function (JSTokenizer, BindingToolkit, CommonUtils, FilterRestrictions, Columns, MetaModelConverter, DataModelPathHelper, PropertyFormatters, FiscalDate, CommonHelper, BindingInfo, AnnotationHelper) {
  "use strict";
  ...
  function maxConditions(path, annotationInterface) {
    ...
    const dataModel = MetaModelConverter.getInvolvedDataModelObjects(model.getContext(propertyLocationPath));
    const filterRestrictions = FilterRestrictions.getFilterRestrictionsByDataModel(dataModel);
  ...
  function constraints(context, annotationInterface, isRuntime) {
  ...
  function formatOptions(context, annotationInterface, isRuntime) {
    ...
    if (context.$Type === "Edm.String") {
      ...
      const typeFormatOptions = getTypeConfig(context, context.$Type)?.formatOptions;
