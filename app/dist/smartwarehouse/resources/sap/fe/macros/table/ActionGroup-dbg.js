...
sap.ui.define(["sap/fe/base/ClassSupport", "sap/fe/macros/controls/BuildingBlockObjectProperty", "sap/fe/macros/table/Action"], function (ClassSupport, BuildingBlockObjectProperty, Action) {
   ...
   * @public
   */
  let ActionGroup = (_dec = defineUI5Class("sap.fe.macros.table.ActionGroup"), _dec2 = implementInterface("sap.fe.macros.table.ITableActionOrGroup"), _dec3 = property({
    type: "string",
    required: true
  }), _dec4 = aggregation({
    ...
    function ActionGroup(settings) {
       ...
       * @public
       */
      _initializerDefineProperty(_this, "actions", _descriptor3, _this);
      /**
       ...
       * @public
       */
      _initializerDefineProperty(_this, "placement", _descriptor6, _this);
      /**
       * Determines the default action to be executed on the action group.
       * @public
       */
      _initializerDefineProperty(_this, "defaultAction", _descriptor7, _this);
      /**
       * Defines the priority of the action in the overflow toolbar.
       * @public
       */
      _initializerDefineProperty(_this, "priority", _descriptor8, _this);
      /**
       * Defines the group of the action in the overflow toolbar.
       */
      _initializerDefineProperty(_this, "group", _descriptor9, _this);
      /**
       * Defines the overflow group of the action in the overflow toolbar.
       * @public
       */
      _initializerDefineProperty(_this, "overflowGroup", _descriptor10, _this);
      return _this;
    }
    ...
    writable: true,
    initializer: null
  }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "actions", [_dec4], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
    ...
    writable: true,
    initializer: null
  }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "placement", [_dec7], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "defaultAction", [_dec8], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "priority", [_dec9], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "group", [_dec10], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "overflowGroup", [_dec11], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
