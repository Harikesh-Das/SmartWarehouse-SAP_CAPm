...
sap.ui.define(["sap/fe/base/ClassSupport", "sap/fe/macros/controls/BuildingBlockObjectProperty", "sap/fe/macros/table/Action"], function (ClassSupport, BuildingBlockObjectProperty, Action) {
   ...
   * @public
   */
  let ActionGroupOverride = (_dec = defineUI5Class("sap.fe.macros.table.ActionGroupOverride"), _dec2 = implementInterface("sap.fe.macros.table.ITableActionOrGroup"), _dec3 = property({
    type: "string",
    required: true
  }), _dec4 = aggregation({
    ...
    function ActionGroupOverride(settings) {
       ...
       */
      _initializerDefineProperty(_this, "group", _descriptor7, _this);
      /**
       * Defines the overflow group of the action in the overflow toolbar.
       * Takes precedence over the group property when defined.
       */
      _initializerDefineProperty(_this, "overflowGroup", _descriptor8, _this);
      return _this;
    }
    ...
    writable: true,
    initializer: null
  }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "overflowGroup", [_dec9], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
