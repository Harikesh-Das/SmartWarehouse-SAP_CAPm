 ...
 */
sap.ui.define(["sap/fe/base/ClassSupport", "../TreeTable"], function (ClassSupport, TreeTableAPI) {
  "use strict";
   ...
   */
  let TreeTable = (_dec = defineUI5Class("sap.fe.macros.table.TreeTable", {
    returnTypes: ["sap.fe.macros.MacroAPI"]
  }), _dec(_class = /*#__PURE__*/function (_TreeTableAPI) {
    function TreeTable(mSettings) {
      for (var _len = arguments.length, others = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
        others[_key - 1] = arguments[_key];
      }
      return _TreeTableAPI.call(this, mSettings, ...others) || this;
    }
     ...
     */
    _exports = TreeTable;
    _inheritsLoose(TreeTable, _TreeTableAPI);
    ...
    _proto.addColumn = function addColumn(column) {
      return _TreeTableAPI.prototype.addColumn.call(this, column);
    }
    ...
    _proto.removeColumn = function removeColumn(column) {
      return _TreeTableAPI.prototype.removeColumn.call(this, column);
    }
    ...
    _proto.addAction = function addAction(action) {
      return _TreeTableAPI.prototype.addAction.call(this, action);
    }
    ...
    _proto.removeAction = function removeAction(action) {
      return _TreeTableAPI.prototype.removeAction.call(this, action);
    };
    return TreeTable;
  }(TreeTableAPI)) || _class);
  _exports = TreeTable;
