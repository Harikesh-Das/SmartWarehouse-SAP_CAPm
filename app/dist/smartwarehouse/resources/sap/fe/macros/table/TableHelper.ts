...
const TableHelper = {
	 ...
	 * @param disableStrictHandling Disable strict handling for this specific action
	...
	buildExpressionForMultiValueFieldReadOnly: function (table: TableAPI): CompiledBindingToolkitExpression {
		return compileExpression(
			ifElse(
