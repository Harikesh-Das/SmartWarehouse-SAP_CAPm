...
sap.ui.define(["sap/fe/core/CommonUtils", "sap/fe/core/converters/ManifestSettings"], function (CommonUtils, ManifestSettings) {
  ...
  function getDesigntimeSettings(table) {
    ...
    getDesigntimeProperties().forEach(setting => {
      if (!setting.restrictedTo || isOnListReport && setting.restrictedTo.includes(TemplateType.ListReport) || !isOnListReport && setting.restrictedTo.includes(TemplateType.ObjectPage)) {
   ...
   */
  function getTableType(control) {
    let tableType = control.data("tableType");
   ...
   */
  _exports.getTableType = getTableType;
  function getSettingsApplicableForTableType(control, items) {
  ...
  _exports.getSettingsApplicableForTableType = getSettingsApplicableForTableType;
  return _exports;
}, false);
