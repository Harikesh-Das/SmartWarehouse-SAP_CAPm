...
sap.ui.define(["sap/fe/base/ClassSupport", "sap/fe/macros/controls/BuildingBlockObjectProperty"], function (ClassSupport, BuildingBlockObjectProperty) {
   ...
   * @public
   */
  let QuickVariantSelection = (_dec = defineUI5Class("sap.fe.macros.table.QuickVariantSelection"), _dec2 = property({
    type: "string[]"
  }), _dec3 = property({
    type: "boolean"
  }), _dec(_class = (_class2 = /*#__PURE__*/function (_BuildingBlockObjectP) {
    function QuickVariantSelection(settings) {
      var _this;
       ...
       * @public
       */
      _initializerDefineProperty(_this, "paths", _descriptor, _this);
      /**
       * Defines whether the counts should be displayed next to the text
       * @public
       */
      _initializerDefineProperty(_this, "showCounts", _descriptor2, _this);
      return _this;
    }
    _exports = QuickVariantSelection;
    _inheritsLoose(QuickVariantSelection, _BuildingBlockObjectP);
    return QuickVariantSelection;
  }(BuildingBlockObjectProperty), _descriptor = _applyDecoratedDescriptor(_class2.prototype, "paths", [_dec2], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
...
//# sourceMappingURL=QuickVariantSelection-dbg.js.map
