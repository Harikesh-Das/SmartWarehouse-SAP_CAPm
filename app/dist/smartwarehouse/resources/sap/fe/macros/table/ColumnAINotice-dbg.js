...
sap.ui.define(["sap/fe/base/ClassSupport", "../controls/BuildingBlockObjectProperty"], function (ClassSupport, BuildingBlockObjectProperty) {
   ...
   * @public
   */
  let ColumnAINotice = (_dec = defineUI5Class("sap.fe.macros.table.ColumnAINotice"), _dec2 = aggregation({
    type: "sap.ui.core.Control",
    isDefault: true,
    multiple: false
  }), _dec(_class = (_class2 = /*#__PURE__*/function (_BuildingBlockObjectP) {
    function ColumnAINotice(settings) {
      var _this;
    ...
    _exports = ColumnAINotice;
    _inheritsLoose(ColumnAINotice, _BuildingBlockObjectP);
    return ColumnAINotice;
  }(BuildingBlockObjectProperty), _descriptor = _applyDecoratedDescriptor(_class2.prototype, "content", [_dec2], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
...
//# sourceMappingURL=ColumnAINotice-dbg.js.map
