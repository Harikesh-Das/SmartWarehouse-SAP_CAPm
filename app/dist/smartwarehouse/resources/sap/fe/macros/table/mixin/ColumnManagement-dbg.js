 ...
 */
sap.ui.define(["sap/fe/base/BindingToolkit", "sap/fe/core/CommonUtils", "sap/fe/core/converters/MetaModelConverter", "sap/fe/core/helpers/ResourceModelHelper", "sap/fe/core/helpers/StandardRecommendationHelper", "sap/fe/core/templating/DataFieldFormatters"], function (BindingToolkit, CommonUtils, MetaModelConverter, ResourceModelHelper, StandardRecommendationHelper, DataFieldFormatters) {
  "use strict";
  ...
  let ColumnManagement = /*#__PURE__*/function () {
    ...
    _proto.getTableColValue = function getTableColValue(tableRowContext, textAnnotationPath, textArrangement, tableColProperty) {
      ...
      const colInfo = this.getKeyColumnInfo(key);
      const columnLabel = colInfo?.label ? CommonUtils.getTranslatedTextFromExpBindingString(colInfo.label, this) : "";
