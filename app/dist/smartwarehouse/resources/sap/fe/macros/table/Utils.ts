...
import CollectionBindingInfoAPI, { type SerializedCollectionBindingInfo } from "../CollectionBindingInfo";
 ...
 * @returns The count
 */
async function requestCountForTable(
	table: Table,
	...
	let filters = (Array.isArray(params.additionalFilters) ? params.additionalFilters : [])
	...
	if (table.getDataStateIndicator()?.isFiltering()) {
		...
		const bindingInfoBase: SerializedCollectionBindingInfo = {};
