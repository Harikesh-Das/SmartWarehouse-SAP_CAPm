...
sap.ui.define(["sap/base/Log", "sap/base/util/merge", "sap/fe/base/ClassSupport", "sap/fe/base/HookSupport", "sap/fe/core/CommonUtils", "sap/fe/core/converters/MetaModelConverter", "sap/fe/core/helpers/StableIdHelper", "sap/fe/macros/chart/Action", "sap/fe/macros/chart/ChartRuntime", "sap/fe/macros/chart/ChartUtils", "sap/fe/macros/filter/FilterUtils", "sap/fe/navigation/PresentationVariant", "sap/ui/core/library", "sap/ui/mdc/p13n/StateUtil", "sap/ui/model/Filter", "./MacroAPI", "./chart/MdcChartTemplate", "./chart/adapter/ChartPvToStateUtils", "./insights/AnalyticalInsightsHelper", "./insights/CommonInsightsHelper", "./insights/InsightsService", "./mdc/adapter/StateHelper"], function (Log, merge, ClassSupport, HookSupport, CommonUtils, MetaModelConverter, StableIdHelper, Action, ChartRuntime, ChartUtils, FilterUtils, PresentationVariant, library, StateUtil, Filter, MacroAPI, MdcChartTemplate, PresentationVariantToStateUtilsPV, AnalyticalInsightsHelper, CommonInsightsHelper, InsightsService, StateHelper) {
  ...
  let Chart = (_dec = defineUI5Class("sap.fe.macros.Chart", {
  ...
  }), _dec2 = implementInterface("sap.fe.core.controllerextensions.viewState.IViewStateContributor"), _dec3 = implementInterface("sap.fe.macros.contentSwitcher.IContentSwitcherHost"), _dec4 = implementInterface("sap.fe.macros.controls.section.ISingleSectionContributor"), _dec5 = property({
    type: "string"
  }), _dec6 = property({
    type: "string",
    required: true,
    ...
    type: "sap.fe.macros.chart.OverflowGroup",
    multiple: true
  }), _dec22 = event(), _dec23 = event(), _dec24 = event(), _dec25 = event(), _dec26 = event(), _dec27 = xmlEventHandler(), _dec28 = xmlEventHandler(), _dec29 = controllerExtensionHandler("collaborationManager", "collectAvailableCards"), _dec(_class = (_class2 = /*#__PURE__*/function (_MacroAPI) {
    function Chart(settings, others) {
       ...
       * @public
       */
      _initializerDefineProperty(_this, "header", _descriptor7, _this);
      /**
       * Controls if the header text should be shown or not
       * @public
       */
      _initializerDefineProperty(_this, "headerVisible", _descriptor8, _this);
      /**
       ...
       * @public
       */
      _initializerDefineProperty(_this, "selectionMode", _descriptor9, _this);
      /**
       ...
       * @public
       */
      _initializerDefineProperty(_this, "variantManagement", _descriptor10, _this);
      /**
       ...
       * @public
       */
      _initializerDefineProperty(_this, "personalization", _descriptor11, _this);
      /**
       * Header level of chart
       * @private
       */
      _initializerDefineProperty(_this, "headerLevel", _descriptor12, _this);
      /**
       * Chart delegate
       * @private
       */
      _initializerDefineProperty(_this, "chartDelegate", _descriptor13, _this);
      /**
       * Used internally for LR and OP
       * @private
       */
      _initializerDefineProperty(_this, "_applyIdToContent", _descriptor14, _this);
      /**
       * No data text
       * @private
       */
      _initializerDefineProperty(_this, "noDataText", _descriptor15, _this);
      /**
       ...
       * @public
       */
      _initializerDefineProperty(_this, "filterBar", _descriptor16, _this);
      _initializerDefineProperty(_this, "contentSwitcher", _descriptor17, _this);
      _initializerDefineProperty(_this, "layoutData", _descriptor18, _this);
      /**
       * Aggregate actions of the chart.
       * @public
       */
      _initializerDefineProperty(_this, "actions", _descriptor19, _this);
      /**
       * Aggregate overflowGroups of the chart.
       * @public
       */
      _initializerDefineProperty(_this, "actionOverflowGroups", _descriptor20, _this);
      /**
       ...
       * @public
       */
      _initializerDefineProperty(_this, "selectionChange", _descriptor21, _this);
      /**
       * An event triggered when the chart requests data.
       * @private
       */
      _initializerDefineProperty(_this, "internalDataRequested", _descriptor22, _this);
      /**
       * Event triggered when chart's variant is selected.
       * @private
       */
      _initializerDefineProperty(_this, "variantSelected", _descriptor23, _this);
      /**
       * Event triggered when chart's variant is saved.
       * @private
       */
      _initializerDefineProperty(_this, "variantSaved", _descriptor24, _this);
      /**
       * Event triggered when chart's segmented button i.e., mode between table, chart and chart with table view is selected
       * @private
       */
      _initializerDefineProperty(_this, "segmentedButtonPressed", _descriptor25, _this);
      return _this;
    }
    ...
    _proto.handleVariantIdPassedViaURLParams = async function handleVariantIdPassedViaURLParams() {
      ...
      if (vm && chartVariantId && typeof chartVariantId === "string" && vmType === "Control") {
    ...
    _proto.setAsHost = function setAsHost(contentSwitcher) {
      // If the chart is set to visible, we need to ensure that the contentSwitcher is also included in the chart's action toolbar
      this.content.getActions().find(action => action.getId() === generate([this._contentId, "ContentSwitcher"]))?.setAction(contentSwitcher);
    };
  ...
  }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "__implements__sap_fe_macros_contentSwitcher_IContentSwitcherHost", [_dec3], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
  ...
  }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "__implements__sap_fe_macros_controls_section_ISingleSectionContributor", [_dec4], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
    ...
    writable: true,
    initializer: null
  }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "variantManagement", [_dec11], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
    ...
    writable: true,
    initializer: null
  }), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, "headerLevel", [_dec13], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
  ...
  }), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, "chartDelegate", [_dec14], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor14 = _applyDecoratedDescriptor(_class2.prototype, "_applyIdToContent", [_dec15], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
  ...
  }), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, "noDataText", [_dec16], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor16 = _applyDecoratedDescriptor(_class2.prototype, "filterBar", [_dec17], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor17 = _applyDecoratedDescriptor(_class2.prototype, "contentSwitcher", [_dec18], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor18 = _applyDecoratedDescriptor(_class2.prototype, "layoutData", [_dec19], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
    ...
    writable: true,
    initializer: null
  }), _descriptor20 = _applyDecoratedDescriptor(_class2.prototype, "actionOverflowGroups", [_dec21], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor21 = _applyDecoratedDescriptor(_class2.prototype, "selectionChange", [_dec22], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor22 = _applyDecoratedDescriptor(_class2.prototype, "internalDataRequested", [_dec23], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor23 = _applyDecoratedDescriptor(_class2.prototype, "variantSelected", [_dec24], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor24 = _applyDecoratedDescriptor(_class2.prototype, "variantSaved", [_dec25], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor25 = _applyDecoratedDescriptor(_class2.prototype, "segmentedButtonPressed", [_dec26], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _applyDecoratedDescriptor(_class2.prototype, "handleSelectionChange", [_dec27], Object.getOwnPropertyDescriptor(_class2.prototype, "handleSelectionChange"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "onInternalDataRequested", [_dec28], Object.getOwnPropertyDescriptor(_class2.prototype, "onInternalDataRequested"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "collectAvailableCards", [_dec29], Object.getOwnPropertyDescriptor(_class2.prototype, "collectAvailableCards"), _class2.prototype), _class2)) || _class);
  _exports = Chart;
  return _exports;
}, false);
