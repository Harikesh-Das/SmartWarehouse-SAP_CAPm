 ...
 */
sap.ui.define(["sap/fe/core/helpers/StableIdHelper", "sap/fe/core/templating/DataModelPathHelper", "sap/fe/core/templating/PropertyHelper", "sap/m/HBox", "sap/m/VBox", "sap/ui/mdc/enums/FieldEditMode", "../../CommonHelper", "../../ValueHelp", "../../controls/FieldWrapper", "../../field/FieldHelper", "./DisplayStyle", "./EditStyle", "./FieldStructureHelper", "sap/fe/base/jsx-runtime/jsx", "sap/fe/base/jsx-runtime/jsxs"], function (StableIdHelper, DataModelPathHelper, PropertyHelper, HBox, VBox, FieldEditMode, CommonHelper, ValueHelp, FieldWrapper, FieldHelper, DisplayStyle, EditStyle, FieldStructureHelper, _jsx, _jsxs) {
  "use strict";
  ...
  /**
   * The function calculates the corresponding ValueHelp field if it´s
