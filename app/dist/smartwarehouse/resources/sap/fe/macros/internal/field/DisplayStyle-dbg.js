...
sap.ui.define(["sap/base/util/uid", "sap/fe/base/BindingToolkit", "sap/fe/core/controls/FormElementWrapper", "sap/fe/core/converters/MetaModelConverter", "sap/fe/core/converters/controls/Common/Action", "sap/fe/core/formatters/ValueFormatter", "sap/fe/core/helpers/BindingHelper", "sap/fe/core/helpers/StableIdHelper", "sap/fe/core/templating/CriticalityFormatters", "sap/fe/core/templating/DataModelPathHelper", "sap/fe/core/templating/UIFormatters", "sap/fe/macros/controls/Avatar", "sap/fe/macros/field/FieldHelper", "sap/fe/macros/field/FieldTemplating", "sap/fe/macros/quickView/QuickView", "sap/m/AvatarSize", "sap/m/Button", "sap/m/CheckBox", "sap/m/ExpandableText", "sap/m/HBox", "sap/m/ImageCustomData", "sap/m/Label", "sap/m/Link", "sap/m/ObjectIdentifier", "sap/m/ObjectStatus", "sap/m/Text", "sap/m/VBox", "sap/m/library", "sap/ui/core/CustomData", "sap/ui/core/Icon", "sap/ui/mdc/enums/FieldEditMode", "sap/ui/unified/FileUploader", "sap/ui/unified/FileUploaderHttpRequestMethod", "../../contact/Contact", "../../contact/Email", "../../controls/ConditionalWrapper", "../../controls/FileWrapper", "../../controls/NumberWithUnitOrCurrency", "../../controls/TextLink", "../../draftIndicator/DraftIndicator", "../../situations/SituationsIndicator", "../DataPoint", "../DataPointFormatOptions", "sap/fe/base/jsx-runtime/jsx", "sap/fe/base/jsx-runtime/jsxs"], function (uid, BindingToolkit, FormElementWrapper, MetaModelConverter, Action, valueFormatters, BindingHelper, StableIdHelper, CriticalityFormatters, DataModelPathHelper, UIFormatters, Avatar, FieldHelper, FieldTemplating, QuickView, AvatarSize, Button, CheckBox, ExpandableText, HBox, ImageCustomData, Label, Link, ObjectIdentifier, ObjectStatus, Text, VBox, library, CustomData, Icon, FieldEditMode, FileUploader, FileUploaderHttpRequestMethod, Contact, Email, ConditionalWrapper, FileWrapper, NumberWithUnitOrCurrency, TextLink, DraftIndicator, SituationsIndicator, DataPoint, DataPointFormatOptions, _jsx, _jsxs) {
  ...
  var getTooltipValue = UIFormatters.getTooltipValue;
  ...
  const DisplayStyle = {
    // If link display style suppression is requested (e.g. value help context), render a non-interactive Text instead.
    getTextTemplateForSuppressedLink(field) {
      // Use optional chaining in case formatOptions is undefined.
      if (field.formatOptions?.suppressLinkDisplayStyle) {
        return this.getTextTemplate(field);
      }
      return undefined;
    },
      ...
      if (field.formatOptions.isAnalytics) {
        return _jsx(ConditionalWrapper, {
          ...
          children: {
            ...
            contentFalse: FieldTemplating.getMultiCurrencyLink(field, currency, overallVisible)
          }
        });
      } else {
        return currency;
    ...
    getAvatarTemplate(field) {
      ...
      return _jsx(FormElementWrapper, {
        ...
        children: _jsx(Avatar, {
          ...
          showLightBox: field.formatOptions?.enableEnlargeImage,
    ...
    getDataPointInnerPart(field, withConditionalWrapper) {
      ...
      const formatOptions = {
        ...
        showEmptyIndicator: field.formatOptions.showEmptyIndicator,
        suppressLinkDisplayStyle: field.formatOptions.suppressLinkDisplayStyle
      };
      ...
      if ((field.formatOptions.isAnalytics ?? false) && (field.hasUnitOrCurrency ?? false)) {
        return _jsx(ConditionalWrapper, {
          ...
          children: {
            ...
            contentFalse: FieldTemplating.getMultiCurrencyLink(field, this.getDataPointInnerPart(field, true))
          }
        });
      } else {
    ...
    getLinkTemplate(field) {
      // If link display style is suppressed, return the Text template instead of building a Link.
      const suppressedTemplate = this.getTextTemplateForSuppressedLink(field);
      if (suppressedTemplate) {
        return suppressedTemplate;
      }
      let linkUrl;
      let iconUrl;
      let linkActived;
      ...
      switch (field.convertedMetaPath.$Type) {
        case "com.sap.vocabularies.UI.v1.DataFieldWithIntentBasedNavigation":
          return _jsx(Link, {
            ...
            children: {
              customData: _jsx(CustomData, {
                value: {
                  semanticObject: field.convertedMetaPath.SemanticObject,
                  action: field.convertedMetaPath.Action
                }
              }, "IBNData")
            }
          });
        ...
        case "com.sap.vocabularies.UI.v1.DataFieldWithUrl":
          {
            const html5LinkTarget = field.convertedMetaPath.annotations?.HTML5?.LinkTarget ?? field.property.annotations.HTML5?.LinkTarget;
    ...
    getObjectStatus(field) {
      ...
      const toolTipValue = getTooltipValue(dataModelObjectPath, enhancedValueDataModelPath);
      ...
      if (field.formatOptions.isAnalytics && field.hasUnitOrCurrency) {
        const content = FieldTemplating.getMultiCurrencyLink(field, _jsx(Text, {
          text: field.text,
          textAlign: "End"
        }));
