...
export const requiresValidation = function (target: Property | ActionParameter): boolean {
	return (
		...
		(hasValueHelp(target) && (isUnit(target) || isCurrency(target) || isGuid(target) || hasExternalId(target)))
	);
};
 ...
 */
export const getSuppressLinkDisplayStyleForValueHelp = function (enableLinksInDialogTable: boolean): boolean {
