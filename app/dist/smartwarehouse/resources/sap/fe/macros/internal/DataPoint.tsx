...
export default class DataPoint extends BuildingBlock<Control> {
	...
	createObjectStatus(dataModelPath: DataModelObjectPath<DataPointType>): ObjectStatus {
		...
		return (
			<ObjectStatus
				...
				emptyIndicatorMode={emptyIndicatorMode}
				active={!this.formatOptions?.suppressLinkDisplayStyle && this.hasQuickView}
	 ...
	 */
	private getTooltipValue(): BindingToolkitExpression<string> | undefined {
		return UIFormatters.getTooltipValue(this.dataModelPath, this.valueDataModelPath);
	}
