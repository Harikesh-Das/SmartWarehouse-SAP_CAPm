 ...
 */
sap.ui.define(["sap/fe/base/BindingToolkit", "sap/fe/base/ClassSupport", "sap/fe/core/buildingBlocks/BuildingBlock", "sap/fe/core/helpers/StableIdHelper", "sap/fe/core/helpers/TypeGuards", "sap/fe/core/templating/DataModelPathHelper", "sap/fe/macros/contact/ContactHelper", "sap/fe/macros/field/FieldTemplating", "sap/ui/mdc/Field", "sap/ui/mdc/Link", "sap/fe/base/jsx-runtime/jsx"], function (BindingToolkit, ClassSupport, BuildingBlock, StableIdHelper, TypeGuards, DataModelPathHelper, ContactHelper, FieldTemplating, MdcField, MdcLink, _jsx) {
  "use strict";
  ...
  let Contact = (_dec = defineUI5Class("sap.fe.macros.contact.Contact"), _dec2 = association({
    ...
    _proto.createContent = function createContent() {
      ...
      let value = getExpressionFromAnnotation(contactDataModelObjectPath.targetObject?.fn, getRelativePaths(contactDataModelObjectPath));
      ...
      if (isPathAnnotationExpression(fnValue)) {
        ...
        if (fnTarget?.annotations?.Common?.Text) {
          ...
          value = addTextArrangementToBindingExpression(value, contactDataModelObjectPath);
        }
      }
