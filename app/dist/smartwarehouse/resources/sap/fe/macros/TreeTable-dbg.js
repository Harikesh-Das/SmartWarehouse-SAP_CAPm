 ...
 */
sap.ui.define(["sap/fe/base/ClassSupport", "./Table", "./table/TreeTableCreationOptions"], function (ClassSupport, TableAPI, TreeTableCreationOptions) {
  "use strict";
   ...
   * @public
   */
  let TreeTableAPI = (_dec = defineUI5Class("sap.fe.macros.TreeTable", {
