...
import type { OverflowGroupsConfiguration } from "sap/fe/core/converters/ManifestSettings";
...
import type { ChartContextObjectPath, ChartCustomData, CommandAction } from "./chart/MdcChartTemplate";
import { getMdcChartTemplate } from "./chart/MdcChartTemplate";
import type OverflowGroup from "./chart/OverflowGroup";
...
type ActionOrActionGroup = Record<string, Action | ActionGroup>;
...
export default class Chart extends MacroAPI implements ISingleSectionContributor, IViewStateContributor<ChartState>, IContentSwitcherHost {
	 ...
	 */
	@event()
	selectionChange!: EventHandler<UI5Event<{ data: unknown[]; selected: boolean }, Chart>>;
	...
	setAsHost(contentSwitcher: ContentSwitcher): void {
		...
		(
			this.content
				.getActions()
				.find((action) => action.getId() === generate([this._contentId, "ContentSwitcher"])) as ActionToolbarAction
