 ...
 */
sap.ui.define(["sap/fe/base/BindingToolkit", "sap/fe/base/ClassSupport", "sap/fe/core/buildingBlocks/BuildingBlock", "sap/fe/core/converters/annotations/DataField", "sap/fe/core/helpers/TypeGuards", "sap/fe/core/templating/DataModelPathHelper", "sap/fe/core/templating/UIFormatters", "sap/fe/macros/controls/Avatar", "sap/fe/macros/field/FieldHelper", "sap/fe/macros/field/FieldTemplating", "sap/m/AvatarShape", "sap/m/Link", "sap/m/Text", "sap/m/Title", "sap/m/VBox", "sap/ui/core/library", "sap/ui/layout/HorizontalLayout", "sap/ui/layout/VerticalLayout", "sap/fe/base/jsx-runtime/jsx", "sap/fe/base/jsx-runtime/jsxs"], function (BindingToolkit, ClassSupport, BuildingBlock, DataField, TypeGuards, DataModelPathHelper, UIFormatters, Avatar, FieldHelper, FieldTemplating, AvatarShape, Link, Text, Title, VBox, coreLibrary, HorizontalLayout, VerticalLayout, _jsx, _jsxs) {
  "use strict";
  ...
  let QuickViewHeaderOptions = (_dec = defineUI5Class("sap.fe.macros.quickView.QuickViewHeaderOptions"), _dec2 = property({
    ...
    _proto.createContent = function createContent() {
      ...
      if (this.icon !== undefined && this.fallbackIcon !== undefined) {
        avatar = _jsx(Avatar, {
