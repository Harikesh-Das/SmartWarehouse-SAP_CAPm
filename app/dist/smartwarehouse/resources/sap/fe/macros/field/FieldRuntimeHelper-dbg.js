 ...
 */
sap.ui.define(["sap/base/Log", "sap/fe/core/CommonUtils", "sap/fe/core/controllerextensions/collaboration/CollaborationCommon", "sap/fe/core/controllerextensions/editFlow/draft", "sap/fe/core/helpers/KeepAliveHelper", "sap/fe/core/helpers/ModelHelper", "sap/fe/core/helpers/ResourceModelHelper", "sap/m/IllustratedMessage", "sap/m/IllustratedMessageSize", "sap/m/IllustratedMessageType", "sap/m/MessageBox", "sap/m/ResponsivePopover", "sap/m/library", "sap/ui/Device", "sap/ui/core/IconPool", "sap/ui/util/openWindow", "../controls/FieldWrapper", "../internal/helpers/Upload"], function (Log, CommonUtils, CollaborationCommon, draft, KeepAliveHelper, ModelHelper, ResourceModelHelper, IllustratedMessage, IllustratedMessageSize, IllustratedMessageType, MessageBox, ResponsivePopover, mobilelibrary, Device, IconPool, openWindow, FieldWrapper, Upload) {
  "use strict";
  ...
  const FieldRuntimeHelper = {
    ...
    fetchRecommendations: function (field, controller) {
      ...
      if (!fieldBindingContext || !fieldBindingContext.isA("sap.ui.model.odata.v4.Context")) {
        return;
      }
      ...
      const odataContext = fieldBindingContext?.isA?.("sap.ui.model.odata.v4.Context") ? fieldBindingContext : undefined;
     ...
     */
    updateIBNLinkEnabled: async function (source, semanticObject, action) {
      ...
      const getIbnParams = async () => {
        if (!bindingContext) {
          return {};
        }
        try {
          const oData = await bindingContext.requestObject();
          if (!oData) {
            return {};
          }
          return Object.keys(oData).reduce((params, key) => {
          ...
          Log.error("Cannot retrieve context data for IBN link authorization check", error);
          return {};
        }
      };
      ...
      internalModelContext.setProperty(`ibn/${semanticObject}-${action}/bEnabled`, true);
      ...
      try {
        ...
        internalModelContext.setProperty(`ibn/${semanticObject}-${action}/bEnabled`, bEnabled);
      } catch (error) {
        Log.error("Cannot retrieve the links from the shell service for IBN link", error);
      }
    },
    /**
