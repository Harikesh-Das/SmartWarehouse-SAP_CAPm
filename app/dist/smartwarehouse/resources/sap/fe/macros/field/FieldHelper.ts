...
import { getPropertyPath, putDefaultQualifierFirst } from "sap/fe/macros/internal/valuehelp/ValueHelpUtils";
...
const FieldHelper = {
	...
	getValueHelpPropertyForFilterField: function (
		...
		const oModel = propertyContext.getModel() as ODataMetaModel,
			...
			oFilterRestrictions = FilterRestrictions.getFilterRestrictionsByDataModel(
