...
export const addTextArrangementToBindingExpression = function (
	...
	fullContextPath: DataModelObjectPath<PageContextPathTarget | ContactType>
...
export const getTextBinding = function (
	...
	if (valueBinding && typeof valueBinding === "string") {
		return valueBinding as CompiledBindingToolkitExpression;
	}
...
export const getValueBinding = function (
	oPropertyDataModelObjectPath: DataModelObjectPath<Property | DataFieldTypes | ActionParameter>,
	fieldFormatOptions: Partial<FieldFormatOptions>,
	ignoreUnit = false,
	...
	if (isProperty(targetObject) || isActionParameter(targetObject)) {
		...
		if (isPathInModelExpression(oBindingExpression)) {
			if ((targetObject.annotations?.Communication as { IsEmailAddress?: boolean })?.IsEmailAddress) {
...
export const setEditStyleProperties = function (
	...
	if (
		...
		if (!onlyEditStyle) {
			...
			const isJSONModelUsedForValue =
				!!oProps.value &&
				(isJSONModelStringBinding || (typeof oProps.value === "object" && oProps.value !== null && "model" in oProps.value));
 ...
 */
export const getMultiCurrencyLink = function (
