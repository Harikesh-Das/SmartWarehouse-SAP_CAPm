...
sap.ui.define(["sap/ui/core/date/UniversalDateUtils", "sap/ui/mdc/condition/FilterOperatorUtil", "sap/ui/mdc/condition/Operator", "sap/ui/model/Filter", "sap/ui/model/FilterOperator", "sap/ui/model/ValidateException"], function (UniversalDateUtils, FilterOperatorUtil, Operator, Filter, ModelOperator, ValidateException) {
  ...
  _exports.lastDateOperators = lastDateOperators;
  const nextDateOperators = {
    NEXTDAYS: {
      key: "NEXTDAYS",
      category: DYNAMIC_DATE_INT_CATEGORY
    },
  ...
  _exports.nextDateOperators = nextDateOperators;
  const lastIncludedDateOperators = {
    LASTMINUTESINCLUDED: {
  ...
  _exports.lastIncludedDateOperators = lastIncludedDateOperators;
  const nextIncludedDateOperators = {
    NEXTMINUTESINCLUDED: {
  ...
  _exports.nextIncludedDateOperators = nextIncludedDateOperators;
  const defaultSemanticDateOperations = {
    ...
    ...lastDateOperators,
    ...nextDateOperators,
    ...lastIncludedDateOperators,
    ...nextIncludedDateOperators
  };
