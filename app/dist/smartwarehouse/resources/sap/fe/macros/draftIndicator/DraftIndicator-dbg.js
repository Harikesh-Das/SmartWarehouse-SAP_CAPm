...
sap.ui.define(["sap/base/strings/formatMessage", "sap/fe/base/BindingToolkit", "sap/fe/base/ClassSupport", "sap/fe/core/CommonUtils", "sap/fe/core/buildingBlocks/BuildingBlock", "sap/fe/core/helpers/BindingHelper", "sap/m/Button", "sap/m/ObjectMarker", "sap/m/Popover", "sap/m/Text", "sap/m/VBox", "sap/m/library", "sap/ui/core/Lib", "sap/fe/base/jsx-runtime/jsx", "sap/fe/base/jsx-runtime/jsxs"], function (formatMessage, BindingToolkit, ClassSupport, CommonUtils, BuildingBlock, BindingHelper, Button, ObjectMarker, Popover, Text, VBox, library, Library, _jsx, _jsxs) {
  ...
  let DraftIndicator = (_dec = defineUI5Class("sap.fe.macros.draftIndicator.DraftIndicator"), _dec2 = property({
     ...
     * @param hasDraftEntity Whether the entity has a draft
     * @param draftInProcessByUser User currently processing the draft
     * @param draftLastChangedByUser User who last changed the draft
     * @param draftInProcessByUserDesc Description of user currently processing the draft
     * @param draftLastChangedByUserDesc Description of user who last changed the draft
     * @returns Text to display
     */;
    _proto.formatDraftOwnerTextInPopover = function formatDraftOwnerTextInPopover(hasDraftEntity, draftInProcessByUser, draftLastChangedByUser, draftInProcessByUserDesc, draftLastChangedByUserDesc) {
      if (hasDraftEntity) {
        const userDescription = draftInProcessByUserDesc || draftInProcessByUser || draftLastChangedByUserDesc || draftLastChangedByUser;
        if (!userDescription) {
          return this.getTranslatedText("M_FIELD_RUNTIME_DRAFT_POPOVER_UNSAVED_CHANGES_BY_UNKNOWN");
        } else {
          return draftInProcessByUser ? this.getTranslatedText("M_FIELD_RUNTIME_DRAFT_POPOVER_LOCKED_BY_KNOWN", [userDescription]) : this.getTranslatedText("M_FIELD_RUNTIME_DRAFT_POPOVER_UNSAVED_CHANGES_BY_KNOWN", [userDescription]);
        }
      } else {
        return this.getTranslatedText("M_FIELD_RUNTIME_DRAFT_POPOVER_NO_DATA_TEXT");
      }
    }
    ...
    _proto.getDraftOwnerTextBindingExpression = function getDraftOwnerTextBindingExpression() {
      ...
      return {
        parts,
        formatter: this.formatDraftOwnerTextInPopover.bind(this)
      };
    }
    ...
    _proto.createPopover = function createPopover(control) {
      ...
      const popover = _jsx(Popover, {
        ...
        endButton: _jsx(Button, {
          ...
          tooltip: resourceBundle.getText("C_DRAFTINDICATOR_CLOSE_BUTTON"),
          press: () => {
