...
sap.ui.define(["sap/base/Log", "sap/fe/base/BindingToolkit", "sap/fe/core/CommonUtils", "sap/fe/core/converters/controls/Common/Action", "sap/fe/core/converters/controls/Common/filter/FilterRestrictions", "sap/fe/core/converters/MetaModelConverter", "sap/fe/core/helpers/MetaModelFunction", "sap/fe/core/helpers/ModelHelper", "sap/fe/macros/filterBar/DefaultSemanticDateOperators", "sap/fe/macros/filterBar/ExtendedSemanticDateOperators", "sap/fe/macros/filterBar/SemanticDateOperators", "sap/m/library", "sap/ui/Device", "sap/ui/mdc/condition/FilterOperatorUtil", "sap/ui/mdc/enums/FieldEditMode", "sap/ui/mdc/odata/v4/TypeMap", "sap/ui/model/Context", "sap/ui/model/odata/v4/AnnotationHelper"], function (Log, BindingToolkit, CommonUtils, Action, FilterRestrictions, MetaModelConverter, MetaModelFunction, ModelHelper, DefaultSemanticDateOperators, ExtendedSemanticDateOperators, SemanticDateOperators, mLibrary, Device, FilterOperatorUtil, FieldEditMode, TypeMap, Context, ODataModelAnnotationHelper) {
   ...
   */
  function _isOperatorExcludedByManifest(operatorName, oSettings) {
    if (!oSettings?.operatorConfiguration) return false;
    return oSettings.operatorConfiguration.some(config => config.path === "key" && config.equals === operatorName && config.exclude === true);
  }
   ...
   */
  function _getEmptyOps(sType, oSettings, bSemanticDateRange) {
  ...
  const CommonHelper = {
    ...
    getOperatorsForProperty: function (sProperty, sEntitySetPath, oContext, sType, bUseSemanticDateRange, settings) {
      ...
      const oFilterRestrictions = FilterRestrictions.getFilterRestrictionsByDataModel(dataModel);
      const aEqualsOps = ["EQ"];
      ...
      let oSettings = settings ?? {};
      if (typeof oSettings === "string") {
        oSettings = oSettings !== "" ? CommonHelper.parseCustomData(oSettings) : {};
      }
      ...
      if (oFilterRestrictions && oFilterRestrictions.FilterAllowedExpressions && oFilterRestrictions.FilterAllowedExpressions[sProperty]) {
        ...
        switch (sAllowedExpression) {
          ...
          case "SingleRange":
            ...
            break;
          case "MultiRange":
            const multiRangeOps = sType === "Edm.Date" || sType === "Edm.DateTimeOffset" ? [...aMultiRangeOps, ...emptyOps] : aMultiRangeOps;
