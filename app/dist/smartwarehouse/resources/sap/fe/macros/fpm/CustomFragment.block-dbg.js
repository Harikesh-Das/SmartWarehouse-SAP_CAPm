...
sap.ui.define(["sap/fe/core/buildingBlocks/templating/BuildingBlockSupport", "sap/fe/core/buildingBlocks/templating/BuildingBlockTemplateProcessor", "sap/fe/core/buildingBlocks/templating/BuildingBlockTemplatingBase"], function (BuildingBlockSupport, BuildingBlockTemplateProcessor, BuildingBlockTemplatingBase) {
  ...
  let CustomFragmentBlock = (_dec = defineBuildingBlock({
    ...
    function CustomFragmentBlock(props, configuration, settings) {
      ...
      /**
       * Indicates whether this fragment is part of preview mode
       * When false, the entire fragment is only shown in detail mode (after "Show More")
       * This provides section-level show more and less functionality
       */
      _initializerDefineProperty(_this, "isPartOfPreview", _descriptor4, _this);
    ...
    _proto.getTemplate = function getTemplate() {
      ...
      // Add section-level isPartOfPreview information to custom data for template-time processing
      if (this.isPartOfPreview !== undefined) {
        customDataObj["isPartOfPreview"] = this.isPartOfPreview.toString();
      }

      // Use standard fragment rendering with enhanced custom data
    ...
    writable: true,
    initializer: null
  }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "isPartOfPreview", [_dec5], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
