 ...
 */
sap.ui.define(["sap/fe/base/BindingToolkit", "sap/fe/base/ClassSupport", "sap/fe/core/buildingBlocks/BuildingBlock", "sap/fe/core/controllerextensions/collaboration/CollaborationCommon", "sap/fe/core/controls/FormElementWrapper", "sap/fe/core/formatters/CollaborationFormatter", "sap/fe/core/helpers/BindingHelper", "sap/fe/core/helpers/ModelHelper", "sap/fe/core/helpers/StableIdHelper", "sap/fe/core/helpers/TypeGuards", "sap/fe/core/templating/DataModelPathHelper", "sap/fe/core/templating/FieldControlHelper", "sap/fe/core/templating/UIFormatters", "sap/fe/macros/field/FieldHelper", "sap/fe/macros/field/FieldRuntime", "sap/fe/macros/field/FieldTemplating", "sap/fe/macros/multivaluefield/FormatOptions", "sap/fe/macros/multivaluefield/MultiValueFieldRuntime", "sap/m/HBox", "sap/ui/core/CustomData", "sap/ui/core/Element", "sap/ui/mdc/MultiValueField", "sap/ui/mdc/field/MultiValueFieldItem", "./CollaborativeDraftHandler", "./ValueHelp", "sap/fe/base/jsx-runtime/jsx"], function (BindingToolkit, ClassSupport, BuildingBlock, CollaborationCommon, FormElementWrapper, CollaborationFormatters, BindingHelper, ModelHelper, ID, TypeGuards, DataModelPathHelper, FieldControlHelper, UIFormatters, FieldHelper, FieldRuntime, FieldTemplating, FormatOptions, MultiValueFieldRuntime, HBox, CustomData, Element, MultiValueField, MultiValueFieldItem, CollaborativeDraftHandler, ValueHelp, _jsx) {
  "use strict";
  ...
  let MultiValueFieldBlock = (_dec = defineUI5Class("sap.fe.macros.MultiValueField"), _dec2 = implementInterface("sap.ui.core.IFormContent"), _dec3 = property({
    ...
    _proto._getMultiInputSettings = function _getMultiInputSettings(propertyDataModelObjectPath, formatOptions) {
      ...
      const collectionBinding = this.useParentBindingCache && this.editMode === "Display" ? {
        path: collectionPath,
    ...
    _proto.initialize = function initialize(metaContextPath) {
      ...
      // Compute placeholder from DataField annotation only (not from property level)
      this.placeholder = this.convertedDataField?.annotations?.UI?.Placeholder;
    ...
    _proto.createContent = function createContent() {
      ...
      if (metaContextPath) {
        ...
        if (this.collaborationEnabled) {
          ...
          const collDraftHandler = _jsx(CollaborativeDraftHandler, {
    ...
    /**
     * Callback when the user leaves the multi-input field.
     * @param event
     */;
    _proto.onValidateFieldGroup = function onValidateFieldGroup(event) {
      const controller = this._getOwner()?.getRootController();
