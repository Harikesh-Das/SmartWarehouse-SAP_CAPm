...
sap.ui.define(["sap/fe/core/CommonUtils", "sap/ui/mdc/field/FieldBaseDelegate", "sap/ui/mdc/field/MultiValueFieldDelegate"], function (CommonUtils, FieldBaseDelegate, MdcMultiValueFieldDelegate) {
  ...
  return Object.assign({}, MdcMultiValueFieldDelegate, {
    ...
    updateItemsFromConditions: async function (control, conditions) {
    ...
    _updateItemsInODataListBinding: async function (listBinding, conditions, control, keyPath, descriptionPath) {
      ...
      if (contextsToDelete.length > 0) {
        modificationPromises.push(controller.editFlow.deleteMultipleDocuments(contextsToDelete, {
      ...
      if (dataToAdd.length) {
        modificationPromises.push(controller.editFlow.createMultipleDocuments(listBinding, dataToAdd, {
          createAtEnd: true,
          hideBusyIndicator: true,
          requestSideEffects: true,
          doNotWaitForSyncTask: true
