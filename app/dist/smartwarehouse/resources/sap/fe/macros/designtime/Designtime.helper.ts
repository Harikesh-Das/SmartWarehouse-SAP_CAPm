...
import type { TableSettingsData } from "../table/designtime/Table.designtime";
...
export function getSettingsIfKeyUser(
	appComponent: AppComponent,
	items: SettingsData[] | TableSettingsData[]
): SettingsData[] | TableSettingsData[] {
