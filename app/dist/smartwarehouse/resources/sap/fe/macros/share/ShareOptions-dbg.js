...
sap.ui.define(["sap/fe/base/ClassSupport", "sap/fe/macros/controls/BuildingBlockObjectProperty"], function (ClassSupport, BuildingBlockObjectProperty) {
  ...
  let ShareOptions = (_dec = defineUI5Class("sap.fe.macros.share.ShareOptions"), _dec2 = property({
    ...
    function ShareOptions(idOrProps, props) {
      ...
      _initializerDefineProperty(_this, "showSaveAsTile", _descriptor4, _this);
      /**
       ...
       * @public
       */
      _initializerDefineProperty(_this, "showShareInWorkzone", _descriptor5, _this);
      ...
      _this.showSaveAsTile = showSaveAsTile;
      _this.showShareInWorkzone = showShareInWorkzone;
      return _this;
    }
    ...
    writable: true,
    initializer: null
  }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "showSaveAsTile", [_dec5], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "showShareInWorkzone", [_dec6], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
