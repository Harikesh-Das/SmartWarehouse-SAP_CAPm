 ...
 */
sap.ui.define(["sap/base/Log", "sap/fe/core/formatters/Scope", "sap/fe/macros/controls/filterbar/utils/VisualFilterUtils", "sap/fe/macros/filter/FilterUtils", "sap/fe/macros/filterBar/FilterHelper", "sap/ui/core/Lib", "sap/ui/mdc/condition/Condition", "sap/ui/mdc/odata/v4/TypeMap", "sap/ui/mdc/util/FilterUtil", "sap/ui/model/Filter", "sap/ui/model/FilterOperator"], function (Log, Scope, VisualFilterUtils, FilterUtils, FilterHelper, Library, Condition, TypeMap, MdcFilterUtil, Filter, FilterOperator) {
  "use strict";
  ...
  const VisualFilterRuntime = {
    ...
    getFiltersFromConditions() {
      ...
      const aInParameters = oInteractiveChart.data("inParameters");
      ...
      const entityTypePath = sEntitySetPath.endsWith("/") ? sEntitySetPath : `${sEntitySetPath}/`;
      const filterConditions = getFiltersConditionsFromSelectionVariant(entityTypePath, oMetaModel, oSelectionVariantAnnotation, VisualFilterUtils.getCustomConditions.bind(VisualFilterUtils));
      ...
      const aRequiredProperties = oInteractiveChart.data("requiredProperties");
  ...
  // @ts-ignore
  Scope._formatters.VisualFilterRuntime = VisualFilterRuntime;
