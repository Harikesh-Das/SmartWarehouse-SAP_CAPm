 ...
 */
sap.ui.define(["sap/base/Log", "sap/fe/controls/easyFilter/innerControls/BaseFactory", "sap/ui/model/FilterOperator", "sap/ui/unified/Calendar", "../utils"], function (Log, $BaseFactory, FilterOperator, Calendar, EasyFilterUtils) {
  "use strict";
  ...
  let CalenderFactory = /*#__PURE__*/function (_BaseFactory) {
    ...
    _proto.invokeOkButtonHandler = function invokeOkButtonHandler() {
      ...
      const date = calendar?.getSelectedDates()[0].getStartDate();
