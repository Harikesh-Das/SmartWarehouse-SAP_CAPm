...
sap.ui.define(["sap/fe/base/ClassSupport", "sap/fe/core/TemplateComponent"], function (ClassSupport, TemplateComponent) {
  ...
  let FPMComponent = (_dec = defineUI5Class("sap.fe.core.fpm.Component", {
    ...
    _proto._getAdditionalI18nBundles = function _getAdditionalI18nBundles() {
      const additionConfigFPM = this.getAppComponent().getAdditionalConfiguration()["sap.fe.core.fpm"];
      if (additionConfigFPM && additionConfigFPM.i18nBundles) {
        return additionConfigFPM.i18nBundles;
      }
      return _TemplateComponent.prototype._getAdditionalI18nBundles.call(this);
    };
    return FPMComponent;
