...
export const UI = {
	...
	IsOutdated: equal(pathInModel("@$ui5.context.isOutdated"), true),
	AnalyticalRefreshNeeded: equal(pathInModel("analyticalRefreshNeeded", "internal"), true),
...
export const Draft = {
	...
	IsCreatedByMe: equal(pathInModel("DraftAdministrativeData/DraftIsCreatedByMe"), true),
	IsOfCollaborativeType: equal(pathInModel("DraftAdministrativeData/DraftAccessType"), "3")
};
