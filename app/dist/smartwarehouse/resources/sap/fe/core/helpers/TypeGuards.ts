...
import type { Action, ActionParameter, AnnotationPath } from "@sap-ux/vocabularies-types/Edm";
...
/**
 * Checks whether the argument is an {@link ActionParameter}.
 * @param serviceObject The object to be checked.
 * @returns Whether the argument is a {@link ActionParameter}.
 */
export function isActionParameter(serviceObject: unknown): serviceObject is ActionParameter {
