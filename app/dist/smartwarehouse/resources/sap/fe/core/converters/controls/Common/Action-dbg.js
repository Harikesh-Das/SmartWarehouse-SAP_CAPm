...
sap.ui.define(["sap/base/Log", "sap/fe/base/BindingToolkit", "sap/fe/core/converters/ManifestSettings", "sap/fe/core/converters/helpers/ConfigurableObject", "sap/fe/core/converters/helpers/ID", "sap/fe/core/formatters/FPMFormatter", "sap/fe/core/helpers/BindingHelper", "sap/fe/core/helpers/ModelHelper", "sap/fe/core/helpers/StableIdHelper", "sap/fe/core/templating/UIFormatters"], function (Log, BindingToolkit, ManifestSettings, ConfigurableObject, ID, fpmFormatter, BindingHelper, ModelHelper, StableIdHelper, UIFormatters) {
   ...
   */
  function getActionOverrideConfig() {
    let includeNavigation = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
    let includeSelection = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    const config = {
   ...
   */
  _exports.getActionOverrideConfig = getActionOverrideConfig;
  ...
  function getManifestActionBooleanPropertyWithFormatter(propertyValue, converterContext) {
    ...
    if (isConstant(resolvedBinding) && resolvedBinding.value === undefined) {
      ...
      result = formatResult([pathInModel("/", "$view"), methodPath, pathInModel(internalModelPath, "internal")], fpmFormatter.customBooleanPropertyCheck, !forContextMenu ? converterContext.getDataModelObjectPath().contextLocation?.targetEntityType || converterContext.getEntityType() : undefined);
    } else {
      // then it's a binding
  ...
  function isMenuAIOperation(actions) {
    ...
    actions.forEach(action => {
      if (action.$Type !== undefined) {
        ...
        if (isBaseActionAIOperation(action)) {
          isAIOperationOccurrences++;
        }
      }
    });
  ...
  function isBaseActionAIOperation(action) {
   ...
   */
  function addSeparators(actions, overflowGroupsConfig) {
  ...
  function getCreateNextButtonVisibility(hiddenDraftEnabled, fclEnabled) {
    return ifElse(hiddenDraftEnabled === true, ifElse(fclEnabled === true, and(Draft.IsNewObject, equal(pathInModel("/showSaveAndCancelButton", "fclhelper"), true)), Draft.IsNewObject), Draft.IsNewObject);
  }
  _exports.getCreateNextButtonVisibility = getCreateNextButtonVisibility;
  return _exports;
}, false);
