...
sap.ui.define(["../../helpers/StableIdHelper"], function (StableIdHelper) {
  ...
  const getContentSwitcherId = createIDGenerator("ContentSwitcher");
  _exports.getContentSwitcherId = getContentSwitcherId;
  ...
  const getPageVariantManagementID = createIDGenerator("PageVariantManagement");
  _exports.getPageVariantManagementID = getPageVariantManagementID;
