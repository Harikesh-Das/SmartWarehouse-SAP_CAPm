...
export function getConnectedFieldsData(connectedFields: ConnectedFields): DataFieldAbstractTypes[] {
	return Object.values(connectedFields.Data).filter(
		(connectedField) => (connectedField as DataFieldAbstractTypes)?.hasOwnProperty("Value")
...
export function getConnectedFieldsSeparator(connectedFields: ConnectedFields): string | undefined {
