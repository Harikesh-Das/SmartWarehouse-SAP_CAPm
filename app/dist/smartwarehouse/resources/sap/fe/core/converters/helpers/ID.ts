...
export function createIDGenerator(...sFixedPart: IDPart[]) {
	return function (...sIDPart: IDPart[]): string {
...
export const getSideContentLayoutID = function (sSectionID: string): string {
...
export const getFormStandardActionButtonID = function (sFormContainerId: string, sActionName: string): string {
...
export const getContentSwitcherId = createIDGenerator("ContentSwitcher");
export const getCustomTabID = createIDGenerator("CustomTab");
export const getFilterBarID = createIDGenerator("FilterBar");
export const getDynamicListReportID = function (): string {
	return "fe::ListReport";
};
export const getIconTabBarID = createIDGenerator("TabMultipleMode");
export const getPageVariantManagementID = createIDGenerator("PageVariantManagement");
export const getFilterVariantManagementID = function (sFilterID: string): string {
	return generate([sFilterID, "VariantManagement"]);
};
export const getChartID = createIDGenerator("Chart");
export const getCustomActionID = function (sActionID: string): string {
