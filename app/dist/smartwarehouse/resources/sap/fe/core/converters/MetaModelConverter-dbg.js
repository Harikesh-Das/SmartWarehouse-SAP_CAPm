...
sap.ui.define(["sap/fe/base/BindingToolkit", "sap/fe/core/converters/common/AnnotationConverter", "sap/fe/core/helpers/TypeGuards", "sap/fe/core/services/EnvironmentServiceFactory", "../helpers/StableIdHelper"], function (BindingToolkit, AnnotationConverter, TypeGuards, EnvironmentServiceFactory, StableIdHelper) {
  ...
  var setConverterRootSymbol = BindingToolkit.setConverterRootSymbol;
  ...
  function parseAnnotationObject(annotationObject, currentObjectTarget, annotationsLists, oCapabilities) {
    ...
    if (annotationObject === null) {
      ...
      const value = handleDynamicAnnotationValue(annotationObject);
      if (!value) {
        ...
        Object.keys(annotationObject).forEach(propertyKey => {
          if (propertyKey !== "$Type" && propertyKey !== "$If" && propertyKey !== "$Apply" && propertyKey !== "$And" && propertyKey !== "$In" && propertyKey !== "$Or" && propertyKey !== "$Ne" && propertyKey !== "$Gt" && propertyKey !== "$Ge" && propertyKey !== "$Lt" && propertyKey !== "$Le" && propertyKey !== "$Not" && propertyKey !== "$Eq" && propertyKey !== "$Has" && propertyKey !== "$In" && propertyKey !== "$Add" && propertyKey !== "$Sub" && propertyKey !== "$Mul" && propertyKey !== "$Div" && propertyKey !== "$DivBy" && propertyKey !== "$Mod" && propertyKey !== "$Neg" && !propertyKey.startsWith("@")) {
  ...
  function handleDynamicAnnotationValue(annotationObjectToParse) {
    let value;
    if (annotationObjectToParse.$PropertyPath !== undefined) {
      value = {
        type: "PropertyPath",
        PropertyPath: annotationObjectToParse.$PropertyPath
      };
    } else if (annotationObjectToParse.$NavigationPropertyPath !== undefined) {
      value = {
        type: "NavigationPropertyPath",
        NavigationPropertyPath: annotationObjectToParse.$NavigationPropertyPath
      };
  ...
  function identifyCollectionType(annotationObjectToParse) {
    let collectionType;
  ...
  function prepareEnumTypes(enumTypeDefinition, enumTypeName, namespacePrefix) {
    ...
    Object.keys(enumTypeDefinition).filter(propertyNameOrNot => {
      return propertyNameOrNot != "$Key" && propertyNameOrNot != "$kind" && propertyNameOrNot != "$IsFlags" && propertyNameOrNot != "$UnderlyingType";
    }).sort((a, b) => a > b ? 1 : -1).map(propertyName => {
