...
const VocabularyReferences_1 = __webpack_require__(96);
const utils_1 = __webpack_require__(453);
/**
...
function convertEnumMember(converter, rawEnumMember) {
    ...
    (0, utils_1.lazy)(convertedEnumMember, 'annotations', resolveAnnotations(converter, rawEnumMember));
...
function convertEnumType(converter, rawEnumType) {
    ...
    (0, utils_1.lazy)(convertedEnumType, 'members', converter.convert(rawEnumType.members, convertEnumMember));
    (0, utils_1.lazy)(convertedEnumType, 'annotations', resolveAnnotations(converter, rawEnumType));
...
function convert(rawMetadata) {
    ...
    (0, utils_1.lazy)(convertedOutput, 'enumTypes', converter.convert(converter.rawSchema.enumTypes, convertEnumType));
