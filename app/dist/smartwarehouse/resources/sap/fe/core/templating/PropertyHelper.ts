...
/**
 * Checks whether the property has an ExternalID annotation.
 * @param property The property to be checked
 * @returns `true` if it has an ExternalID annotation
 */
export const hasExternalId = function (property: Property | ActionParameter): boolean {
	return property.annotations?.Common?.ExternalID !== undefined;
};
