 ...
 */
export const computeSelectionVariantAndURLParameters = function (
	selectionVariantToBeModified: SelectionVariant,
	localProperty: string,
	urlParametersFromSelectionVariant: Record<string, string>,
	...
	let localPropertySelectOptionName = selectionVariantToBeModified.getSelectOptionsPropertyNames().find((property: string) => {
