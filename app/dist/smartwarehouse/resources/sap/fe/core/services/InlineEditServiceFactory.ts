	...
	private getAssociatedDataModelObject(
		...
		if (annotationPath.includes(UIAnnotationTerms.FieldGroup)) {
			annotationPath = annotationPath
				.replace("@", "")
				.replace(`${UIAnnotationTerms.FieldGroup}`, `$Type/@${UIAnnotationTerms.FieldGroup}`);
		} else if (annotationPath.includes(UIAnnotationTerms.Identification)) {
			annotationPath = annotationPath
				.replace("@", "")
				.replace(`${UIAnnotationTerms.Identification}`, `$Type/@${UIAnnotationTerms.Identification}`);
		} else if (annotationPath.includes(UIAnnotationTerms.LineItem)) {
			annotationPath = annotationPath
				.replace("@", "")
				.replace(`${UIAnnotationTerms.LineItem}`, `$Type/@${UIAnnotationTerms.LineItem}`);
		}
