  ...
  let InlineEditService = /*#__PURE__*/function (_Service) {
    ...
    _proto.getAssociatedDataModelObject = function getAssociatedDataModelObject(metaModel, annotationPath, pageContextPath) {
      ...
      if (annotationPath.includes("com.sap.vocabularies.UI.v1.FieldGroup")) {
        annotationPath = annotationPath.replace("@", "").replace(`${"com.sap.vocabularies.UI.v1.FieldGroup"}`, `$Type/@${"com.sap.vocabularies.UI.v1.FieldGroup"}`);
      } else if (annotationPath.includes("com.sap.vocabularies.UI.v1.Identification")) {
        annotationPath = annotationPath.replace("@", "").replace(`${"com.sap.vocabularies.UI.v1.Identification"}`, `$Type/@${"com.sap.vocabularies.UI.v1.Identification"}`);
      } else if (annotationPath.includes("com.sap.vocabularies.UI.v1.LineItem")) {
        annotationPath = annotationPath.replace("@", "").replace(`${"com.sap.vocabularies.UI.v1.LineItem"}`, `$Type/@${"com.sap.vocabularies.UI.v1.LineItem"}`);
      }
