 ...
 */
sap.ui.define(["sap/fe/base/ClassSupport", "sap/fe/core/helpers/ResourceModelHelper", "sap/fe/core/helpers/StableIdHelper", "sap/m/Button", "sap/m/CustomListItem", "sap/m/Dialog", "sap/m/Label", "sap/m/List", "sap/m/Text", "sap/m/VBox", "sap/ui/base/ManagedObject", "sap/ui/core/CustomData", "sap/ui/core/library", "sap/ui/performance/trace/FESRHelper", "../../CommonUtils", "sap/fe/base/jsx-runtime/jsx", "sap/fe/base/jsx-runtime/jsxs", "sap/fe/base/jsx-runtime/Fragment"], function (ClassSupport, ResourceModelHelper, StableIdHelper, Button, CustomListItem, Dialog, Label, List, Text, VBox, ManagedObject, CustomData, library, FESRHelper, CommonUtils, _jsx, _jsxs, _Fragment) {
  "use strict";
  ...
  let DraftDataLossDialog = (_dec = defineUI5Class("sap.fe.core.controls.DataLossOrDraftDiscard.DraftDataLossDialog"), _dec2 = defineReference(), _dec3 = defineReference(), _dec(_class = (_class2 = /*#__PURE__*/function (_ManagedObject) {
    ...
    _proto.getConfirmButton = function getConfirmButton() {
      ...
      FESRHelper.setSemanticStepname(button, "press", "fe4:draftLoss:Ok");
      return button;
    }
    ...
    _proto.getCancelButton = function getCancelButton() {
      ...
      FESRHelper.setSemanticStepname(button, "press", "fe4:draftLoss:Cancel");
      return button;
    }
    ...
    _proto.getItems = function getItems(isSave) {
      ...
      let createOrSaveLabel = this.dataLossResourceModel.getText("T_OP_OBJECT_PAGE_SAVE");
      if (isSave) {
        ...
        createOrSaveLabel = this.dataLossResourceModel.getText("T_OP_OBJECT_PAGE_CREATE");
      ...
      items.push(_jsx(CustomListItem, {
        ...
        accDescription: `${createOrSaveLabel}. ${createOrSaveText}`,
        children: _jsxs(VBox, {
