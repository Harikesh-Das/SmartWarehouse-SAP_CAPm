 ...
 */
sap.ui.define(["sap/fe/core/helpers/ResourceModelHelper", "sap/fe/core/helpers/TypeGuards", "sap/m/Bar", "sap/m/Button", "sap/m/Dialog", "sap/m/FormattedText", "sap/m/MessageBox", "sap/m/MessageItem", "sap/m/MessageToast", "sap/m/MessageView", "sap/m/Text", "sap/m/library", "sap/ui/base/ManagedObject", "sap/ui/core/Element", "sap/ui/core/IconPool", "sap/ui/core/Lib", "sap/ui/core/Messaging", "sap/ui/core/format/DateFormat", "sap/ui/core/message/Message", "sap/ui/core/message/MessageType", "sap/ui/model/Filter", "sap/ui/model/FilterOperator", "sap/ui/model/Sorter", "sap/ui/model/json/JSONModel"], function (ResourceModelHelper, TypeGuards, Bar, Button, Dialog, FormattedText, MessageBox, MessageItem, MessageToast, MessageView, Text, MLib, ManagedObject, UI5Element, IconPool, Library, Messaging, DateFormat, Message, MessageType, Filter, FilterOperator, Sorter, JSONModel) {
  "use strict";
  ...
  function setGroupNameLRTable(oElem, aModelData, sActionName) {
    ...
    if (oRowBinding) {
      ...
      if (aModelData.target?.indexOf(sElemeBindingPath) === 0) {
        ...
        oElem.findElements(true).forEach(element => {
          if (element.isA("sap.ui.table.Table") || element.isA("sap.m.Table")) {
        ...
        const allRowContexts = childTableElement?.isA("sap.ui.table.Table") ? oRowBinding.getContexts() : oRowBinding.getCurrentContexts();
   ...
   */
  function isMessageTargetContextPath(messageObject, contextPath) {
   ...
   */
  function getRowIdentifierFromTargetPath(message, table) {
    // Only applies to tree tables
    const isTreeTable = table.findElements(true, el => el.isA("sap.ui.table.TreeTable")).length > 0;
    if (!isTreeTable) {
      return undefined;
    }
    const identifierColumn = table.getParent().getIdentifierColumn();
    if (!identifierColumn) {
      return undefined;
    }
