...
sap.ui.define(["sap/fe/base/ClassSupport", "sap/ui/core/mvc/ControllerExtension"], function (ClassSupport, ControllerExtension) {
  ...
  var _dec, _class, _BaseControllerExtension;
  var _exports = {};
   ...
   * @since 1.118.0
   */
  let BaseControllerExtension = (_dec = defineUI5Class("sap.fe.core.controllerextensions.BaseControllerExtension"), _dec(_class = (_BaseControllerExtension = /*#__PURE__*/function (_ControllerExtension) {
  ...
  }(ControllerExtension), _BaseControllerExtension.createExtensionOverrides = function (overrides) {
    return overrides;
  }, _BaseControllerExtension)) || _class);
  _exports = BaseControllerExtension;
  return _exports;
}, false);
