...
async function processDataLossOrDraftDiscardConfirmation(
	...
	skipBackNavigation?: boolean,
	breadcrumbsBackNavigation?: boolean
): Promise<void> {
	...
	if (
		(originalContext.isDeleted() || (!backNavShowsDialog && navigationType === NavigationType.BackNavigation) || !bIsEditable) &&
		!breadcrumbsBackNavigation
	) {
