...
class PlaceholderControllerExtension extends ControllerExtension {
	...
	hideRootPlaceholder(): void {
		...
		this.oRootContainer.hidePlaceholder({ aggregation: "beginColumnPages" });
		this.oRootContainer.hidePlaceholder({ aggregation: "midColumnPages" });
