...
sap.ui.define(["sap/base/Log", "sap/fe/base/ClassSupport", "sap/fe/base/HookSupport", "sap/fe/core/CommonUtils", "sap/fe/core/controllerextensions/BaseControllerExtension", "sap/fe/core/controllerextensions/messageHandler/messageHandling", "sap/fe/core/controls/inlineEditFlow/InlineEditExitDialog", "sap/fe/core/converters/MetaModelConverter", "sap/fe/core/helpers/TypeGuards", "sap/m/MessageToast", "sap/ui/core/Lib", "sap/ui/core/Messaging", "sap/ui/core/message/MessageType", "../controls/inlineEditFlow/DraftExistsDialog"], function (Log, ClassSupport, HookSupport, CommonUtils, BaseControllerExtension, messageHandling, InlineEditExitDialog, MetaModelConverter, TypeGuards, MessageToast, Lib, Messaging, MessageType, DraftExistsDialog) {
  ...
  let InlineEditFlow = (_dec = defineUI5Class("sap.fe.core.controllerextensions.InlineEditFlow"), _dec2 = hookable("Before"), _dec3 = methodOverride("routing"), _dec4 = methodOverride("_routing"), _dec5 = methodOverride("_routing"), _dec6 = methodOverride("editFlow"), _dec7 = methodOverride("editFlow"), _dec8 = methodOverride("editFlow"), _dec9 = methodOverride("editFlow"), _dec(_class = (_class2 = /*#__PURE__*/function (_BaseControllerExtens) {
    ...
    _proto.inlineEditSave = async function inlineEditSave() {
      ...
      const hasTechnicalErrorMessages = messages.some(message => !messageHandling.isNonTechnicalMessage(message) && message.getType() === MessageType.Error && message.getTechnicalDetails()?.isCustomMessageFromExtensionAPI !== true);
      if (hasTechnicalErrorMessages) {
    ...
    _proto.inlineEditDiscard = function inlineEditDiscard() {
      if (this.inlineEditControls.length) {
     ...
     */;
    _proto.startInlineEdit = async function startInlineEdit(propertyFullyQualifiedName, bindingContextPath, controlTrigger) {
      ...
      if (this.abortTimerBeforeSave) {
        // if there is  a timer to save, we do the save first
        this.abortTimerBeforeSave();
        this.abortTimerBeforeSave = undefined;
        await this.inlineEditSave();
      }
      if (controlTrigger && this.inlineEditControls.length) {
        // if there are still inline edit controls this means and a control trigger we prevent user form starting another inline edit
        return;
      }
      this.inlineEditStart(this.inlineEditControls, dependentProperties?.length ? dependentProperties : [propertyFullyQualifiedName], bindingContextPath);
    ...
    _proto.onBeforeBinding = function onBeforeBinding(_bindingContext, _mParameters) {
      ...
      if (_bindingContext && this.base.getView().getModel().hasPendingChanges(CommonUtils.INLINEEDIT_UPDATEGROUPID)) {
    ...
    _proto.onRouteNotMatched = function onRouteNotMatched() {
      // this is a failsafe if somehow we leave the page without triggering onBeforeNavigation,
      // like  a browser back we make sure to discard the changes
      this.inlineEditDiscard();
    }
  ...
  }(BaseControllerExtension), _applyDecoratedDescriptor(_class2.prototype, "inlineEditStart", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "inlineEditStart"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "onBeforeNavigation", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "onBeforeNavigation"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "onBeforeBinding", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "onBeforeBinding"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "onRouteNotMatched", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "onRouteNotMatched"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "onBeforeEdit", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "onBeforeEdit"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "onBeforeCreate", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "onBeforeCreate"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "onBeforeDelete", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "onBeforeDelete"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "onBeforeExecuteAction", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "onBeforeExecuteAction"), _class2.prototype), _class2)) || _class);
  _exports = InlineEditFlow;
  return _exports;
}, false);
