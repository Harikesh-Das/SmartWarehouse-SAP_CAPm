...
sap.ui.define(["sap/fe/base/ClassSupport", "sap/fe/core/CommonUtils", "sap/ui/core/mvc/ControllerExtension"], function (ClassSupport, CommonUtils, ControllerExtension) {
   ...
   * @since 1.120.0
   */
  let CollaborationManagerExtension = (_dec = defineUI5Class("sap.fe.core.controllerextensions.cards.CollaborationManager"), _dec2 = methodOverride(), _dec3 = methodOverride("_routing"), _dec4 = publicExtension(), _dec5 = extensible("AfterAsync"), _dec(_class = (_class2 = /*#__PURE__*/function (_ControllerExtension) {
  ...
  }(ControllerExtension), _applyDecoratedDescriptor(_class2.prototype, "onInit", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "onInit"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "onAfterBinding", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "onAfterBinding"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "collectAvailableCards", [_dec4, _dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "collectAvailableCards"), _class2.prototype), _class2)) || _class);
  _exports = CollaborationManagerExtension;
  return _exports;
}, false);
