...
sap.ui.define(["sap/base/Log", "sap/fe/base/ClassSupport", "sap/fe/core/converters/MetaModelConverter", "sap/fe/core/helpers/ResourceModelHelper", "sap/m/Button", "sap/m/Dialog", "sap/m/MessageToast", "sap/m/Text", "sap/ui/core/mvc/ControllerExtension", "sap/ui/core/mvc/OverrideExecution", "../CommonUtils", "sap/ui/core/Component", "../helpers/TypeGuards"], function (Log, ClassSupport, MetaModelConverter, ResourceModelHelper, Button, Dialog, MessageToast, Text, ControllerExtension, OverrideExecution, CommonUtils, Component, TypeGuards) {
  ...
  let SideEffectsControllerExtension = (_dec = defineUI5Class("sap.fe.core.controllerextensions.SideEffects"), _dec2 = methodOverride(), _dec3 = publicExtension(), _dec4 = finalExtension(), _dec5 = publicExtension(), _dec6 = finalExtension(), _dec7 = publicExtension(), _dec8 = finalExtension(), _dec9 = publicExtension(), _dec10 = finalExtension(), _dec11 = publicExtension(), _dec12 = finalExtension(), _dec13 = publicExtension(), _dec14 = finalExtension(), _dec15 = publicExtension(), _dec16 = finalExtension(), _dec17 = publicExtension(), _dec18 = finalExtension(), _dec19 = publicExtension(), _dec20 = finalExtension(), _dec21 = publicExtension(), _dec22 = finalExtension(), _dec23 = publicExtension(), _dec24 = finalExtension(), _dec25 = publicExtension(), _dec26 = finalExtension(), _dec27 = publicExtension(), _dec28 = finalExtension(), _dec29 = publicExtension(), _dec30 = finalExtension(), _dec31 = publicExtension(), _dec32 = extensible(OverrideExecution.Instead), _dec33 = publicExtension(), _dec34 = extensible(OverrideExecution.Instead), _dec35 = publicExtension(), _dec36 = extensible(OverrideExecution.Instead), _dec37 = publicExtension(), _dec38 = finalExtension(), _dec39 = privateExtension(), _dec40 = finalExtension(), _dec41 = publicExtension(), _dec42 = finalExtension(), _dec43 = publicExtension(), _dec44 = finalExtension(), _dec45 = privateExtension(), _dec46 = finalExtension(), _dec47 = privateExtension(), _dec48 = finalExtension(), _dec49 = publicExtension(), _dec50 = finalExtension(), _dec51 = publicExtension(), _dec52 = finalExtension(), _dec(_class = (_class2 = /*#__PURE__*/function (_ControllerExtension) {
     ...
     * Application developers can use it to do the following:<br/>
     * - Execute custom logic.<br/>
     * - Inspect app state and conditionally suppress the default refresh workflow
     *   by returning a rejected promise.<br/>
     * - Override the interaction type, such as (None / Notification / Confirmation), for this event.<br/>
     *
     ...
     * @param _mParameters Parameters forwarded from the WebSocket message.
     * @param _mParameters.sideEffectEventName The name of the side-effects event.
     * @param _mParameters.sideEffectSource The OData path that is the source of the event.
     * @returns A promise that resolves with an optional interactionType override, or rejects to stop processing.
     * @public
     * @since 1.148.0
     */;
    _proto.onEventDrivenSideEffectsReceived = async function onEventDrivenSideEffectsReceived(_mParameters) {
     ...
     *
     * The default implementation is to execute the side effect on the page's context, but pages, such as the list report page, may override this method.
    ...
    _proto.requestSideEffectsForEvent = async function requestSideEffectsForEvent(eventName, path) {
      ...
      await CommonUtils.getAppComponent(this._view).getRouterProxy().waitForNavigation();
    ...
    _proto._contextIsRelevant = function _contextIsRelevant(path, context) {
      ...
      if (!contextPath || isAction(getInvolvedDataModelObjectsForTargetPath(contextPath, this._view.getModel().getMetaModel())?.targetObject)) {
        return false;
      }
      if (contextPath === path || context.getCanonicalPath() === path) {
        return true;
      }
      ...
      for (const binding of dependentBindings.filter(binding => !binding.isA("sap.ui.model.odata.v4.ODataContextBinding"))) {
    ...
    _proto.notifyDataRefresh = function notifyDataRefresh() {
      MessageToast.show(this.base.getView().getController().sideEffects.getDataRefreshText());
    }

    /**
     * Ask the user for confirmation of a data refresh.
     *
     * This is only used by SideEffects events.
  ...
  }(ControllerExtension), _applyDecoratedDescriptor(_class2.prototype, "onInit", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "onInit"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "addControlSideEffects", [_dec3, _dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "addControlSideEffects"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "removeControlSideEffects", [_dec5, _dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "removeControlSideEffects"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getContextForSideEffects", [_dec7, _dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "getContextForSideEffects"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "waitForSideEffectExecutions", [_dec9, _dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "waitForSideEffectExecutions"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getFieldSideEffectsMap", [_dec11, _dec12], Object.getOwnPropertyDescriptor(_class2.prototype, "getFieldSideEffectsMap"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getSideEffectsMapForFieldGroups", [_dec13, _dec14], Object.getOwnPropertyDescriptor(_class2.prototype, "getSideEffectsMapForFieldGroups"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "clearFieldGroupsValidity", [_dec15, _dec16], Object.getOwnPropertyDescriptor(_class2.prototype, "clearFieldGroupsValidity"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "isFieldGroupValid", [_dec17, _dec18], Object.getOwnPropertyDescriptor(_class2.prototype, "isFieldGroupValid"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getTargetProperty", [_dec19, _dec20], Object.getOwnPropertyDescriptor(_class2.prototype, "getTargetProperty"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "prepareDeferredSideEffectsForField", [_dec21, _dec22], Object.getOwnPropertyDescriptor(_class2.prototype, "prepareDeferredSideEffectsForField"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "handleFieldChange", [_dec23, _dec24], Object.getOwnPropertyDescriptor(_class2.prototype, "handleFieldChange"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "handleFieldGroupChange", [_dec25, _dec26], Object.getOwnPropertyDescriptor(_class2.prototype, "handleFieldGroupChange"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "handlePageChangeContext", [_dec27, _dec28], Object.getOwnPropertyDescriptor(_class2.prototype, "handlePageChangeContext"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "requestSideEffects", [_dec29, _dec30], Object.getOwnPropertyDescriptor(_class2.prototype, "requestSideEffects"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "onEventDrivenSideEffectsReceived", [_dec31, _dec32], Object.getOwnPropertyDescriptor(_class2.prototype, "onEventDrivenSideEffectsReceived"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "requestSideEffectsForEvent", [_dec33, _dec34], Object.getOwnPropertyDescriptor(_class2.prototype, "requestSideEffectsForEvent"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getDataRefreshText", [_dec35, _dec36], Object.getOwnPropertyDescriptor(_class2.prototype, "getDataRefreshText"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getRegisteredFailedRequests", [_dec37, _dec38], Object.getOwnPropertyDescriptor(_class2.prototype, "getRegisteredFailedRequests"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "registerFailedSideEffects", [_dec39, _dec40], Object.getOwnPropertyDescriptor(_class2.prototype, "registerFailedSideEffects"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "unregisterFailedSideEffectsForAContext", [_dec41, _dec42], Object.getOwnPropertyDescriptor(_class2.prototype, "unregisterFailedSideEffectsForAContext"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "unregisterFailedSideEffects", [_dec43, _dec44], Object.getOwnPropertyDescriptor(_class2.prototype, "unregisterFailedSideEffects"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "registerFieldGroupSideEffects", [_dec45, _dec46], Object.getOwnPropertyDescriptor(_class2.prototype, "registerFieldGroupSideEffects"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "unregisterFieldGroupSideEffects", [_dec47, _dec48], Object.getOwnPropertyDescriptor(_class2.prototype, "unregisterFieldGroupSideEffects"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getRegisteredSideEffectsForFieldGroup", [_dec49, _dec50], Object.getOwnPropertyDescriptor(_class2.prototype, "getRegisteredSideEffectsForFieldGroup"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getRegisteredSideEffectsForContext", [_dec51, _dec52], Object.getOwnPropertyDescriptor(_class2.prototype, "getRegisteredSideEffectsForContext"), _class2.prototype), _class2)) || _class);
  return SideEffectsControllerExtension;
}, false);
