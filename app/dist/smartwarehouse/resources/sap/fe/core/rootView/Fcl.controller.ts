...
class FclController extends BaseController {
	...
	private sCurrentArguments?: {
		noPreservationCache?: boolean;
		bIsStickyMode?: boolean;
		isHiddenDraftEnabled?: boolean;
		["?query"]?: { layout?: string };
	};
	...
	private _currentPromise?: PromiseKeeper<void>;
	...
	_getPaginatorButtonVisibility(sLayout: string): boolean {
	...
	async updateUIStateForView(oView: FEView, FCLLevel: number): Promise<void> {
	 ...
	 */
	getLeftMostViewContextPath(): string | undefined {
