...
interface ReuseComponent {
	attachInitialized(fn: Function, listener?: object): this;
	detachInitialized(fn: Function, listener?: object): this;
	fireInitialized(parameters?: object): this;
}
