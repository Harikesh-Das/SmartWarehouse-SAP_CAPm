...
sap.ui.define([
	...
	Icon, FlexItemData, CoreLibrary, MobileLibrary, Library, Device, CoreLib, Element) {
	"use strict";
	...
	Tooltip.prototype._getOpener = function (oItem, oPoint) {
		if (oItem instanceof Line && oPoint) {
			...
			if (typeof oPoint.x !== 'number' || typeof oPoint.y !== 'number' || 
				isNaN(oPoint.x) || isNaN(oPoint.y)) {
				return oItem;
			}
